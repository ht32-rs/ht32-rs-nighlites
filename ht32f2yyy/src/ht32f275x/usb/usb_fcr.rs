#[doc = "Reader of register USB_FCR"]
pub type R = crate::R<u32, super::USB_FCR>;
#[doc = "Writer for register USB_FCR"]
pub type W = crate::W<u32, super::USB_FCR>;
#[doc = "Register USB_FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_FCR {
    type Type = u32;
    #[inline(always)]
