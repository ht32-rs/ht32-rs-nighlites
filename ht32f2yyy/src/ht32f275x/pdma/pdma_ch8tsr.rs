#[doc = "Reader of register PDMA_CH8TSR"]
pub type R = crate::R<u32, super::PDMA_CH8TSR>;
#[doc = "Writer for register PDMA_CH8TSR"]
pub type W = crate::W<u32, super::PDMA_CH8TSR>;
#[doc = "Register PDMA_CH8TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH8TSR {
    type Type = u32;
    #[inline(always)]
