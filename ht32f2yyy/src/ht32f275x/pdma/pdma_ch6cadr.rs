#[doc = "Reader of register PDMA_CH6CADR"]
pub type R = crate::R<u32, super::PDMA_CH6CADR>;
#[doc = "Writer for register PDMA_CH6CADR"]
pub type W = crate::W<u32, super::PDMA_CH6CADR>;
#[doc = "Register PDMA_CH6CADR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH6CADR {
    type Type = u32;
    #[inline(always)]
