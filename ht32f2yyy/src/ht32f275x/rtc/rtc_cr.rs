...
pub type RTCEN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `RTCSRC` reader - RTCSRC"]
pub type RTCSRC_R = crate::BitReader;
#[doc = "Field `RTCSRC` writer - RTCSRC"]
pub type RTCSRC_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `LSIEN` reader - LSIEN"]
pub type LSIEN_R = crate::BitReader;
#[doc = "Field `LSIEN` writer - LSIEN"]
pub type LSIEN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `LSEEN` reader - LSEEN"]
pub type LSEEN_R = crate::BitReader;
#[doc = "Field `LSEEN` writer - LSEEN"]
pub type LSEEN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `CMPCLR` reader - CMPCLR"]
pub type CMPCLR_R = crate::BitReader;
#[doc = "Field `CMPCLR` writer - CMPCLR"]
pub type CMPCLR_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `LSESM` reader - LSESM"]
pub type LSESM_R = crate::BitReader;
#[doc = "Field `LSESM` writer - LSESM"]
pub type LSESM_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `RPRE` reader - RPRE"]
pub type RPRE_R = crate::FieldReader;
#[doc = "Field `RPRE` writer - RPRE"]
pub type RPRE_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_CR_SPEC, 4, O>;
#[doc = "Field `ROEN` reader - ROEN"]
pub type ROEN_R = crate::BitReader;
#[doc = "Field `ROEN` writer - ROEN"]
pub type ROEN_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `ROES` reader - ROES"]
pub type ROES_R = crate::BitReader;
#[doc = "Field `ROES` writer - ROES"]
pub type ROES_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `ROWM` reader - ROWM"]
pub type ROWM_R = crate::BitReader;
#[doc = "Field `ROWM` writer - ROWM"]
pub type ROWM_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `ROAP` reader - ROAP"]
pub type ROAP_R = crate::BitReader;
#[doc = "Field `ROAP` writer - ROAP"]
pub type ROAP_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
#[doc = "Field `ROLF` reader - ROLF"]
pub type ROLF_R = crate::BitReader;
#[doc = "Field `ROLF` writer - ROLF"]
pub type ROLF_W<'a, const O: u8> = crate::BitWriter<'a, RTC_CR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - RTCEN"]
    #[inline(always)]
