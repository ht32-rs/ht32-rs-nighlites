#[doc = "Register `MCTM_INTSR` reader"]
pub struct R(crate::R<MCTM_INTSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCTM_INTSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCTM_INTSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCTM_INTSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MCTM_INTSR` writer"]
pub struct W(crate::W<MCTM_INTSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MCTM_INTSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MCTM_INTSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MCTM_INTSR_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn brkif(&mut self) -> BRKIF_W<11> {
        BRKIF_W::new(self)
    }
...
#[doc = "MCTM_INTSR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mctm_intsr](index.html) module"]
pub struct MCTM_INTSR_SPEC;
impl crate::RegisterSpec for MCTM_INTSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mctm_intsr::R](R) reader structure"]
impl crate::Readable for MCTM_INTSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mctm_intsr::W](W) writer structure"]
impl crate::Writable for MCTM_INTSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MCTM_INTSR to value 0"]
impl crate::Resettable for MCTM_INTSR_SPEC {
