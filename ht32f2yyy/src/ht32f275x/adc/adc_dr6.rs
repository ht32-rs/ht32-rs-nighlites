#[doc = "Reader of register ADC_DR6"]
pub type R = crate::R<u32, super::ADC_DR6>;
#[doc = "Writer for register ADC_DR6"]
pub type W = crate::W<u32, super::ADC_DR6>;
#[doc = "Register ADC_DR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_DR6 {
    type Type = u32;
    #[inline(always)]
