#[doc = "Reader of register USART1_FSR"]
pub type R = crate::R<u32, super::USART1_FSR>;
#[doc = "Writer for register USART1_FSR"]
pub type W = crate::W<u32, super::USART1_FSR>;
#[doc = "Register USART1_FSR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART1_FSR {
    type Type = u32;
    #[inline(always)]
