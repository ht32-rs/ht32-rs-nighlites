...
#[doc = "Field `TFPR` reader - TFPR"]
pub type TFPR_R = crate::BitReader;
#[doc = "Field `TFPR` writer - TFPR"]
pub type TFPR_W<'a, const O: u8> = crate::BitWriter<'a, SPI_FCR_SPEC, O>;
#[doc = "Field `RFPR` reader - RFPR"]
pub type RFPR_R = crate::BitReader;
#[doc = "Field `RFPR` writer - RFPR"]
pub type RFPR_W<'a, const O: u8> = crate::BitWriter<'a, SPI_FCR_SPEC, O>;
...
impl R {
    ...
    pub fn tfpr(&self) -> TFPR_R {
        TFPR_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - RFPR"]
    #[inline(always)]
    pub fn rfpr(&self) -> RFPR_R {
        RFPR_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - FIFOEN"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfpr(&mut self) -> TFPR_W<8> {
        TFPR_W::new(self)
    }
    #[doc = "Bit 9 - RFPR"]
    #[inline(always)]
    #[must_use]
    pub fn rfpr(&mut self) -> RFPR_W<9> {
        RFPR_W::new(self)
    }
    #[doc = "Bit 10 - FIFOEN"]
    #[inline(always)]
