#[doc = "Reader of register USART0_TPR"]
pub type R = crate::R<u32, super::USART0_TPR>;
#[doc = "Writer for register USART0_TPR"]
pub type W = crate::W<u32, super::USART0_TPR>;
#[doc = "Register USART0_TPR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART0_TPR {
    type Type = u32;
    #[inline(always)]
