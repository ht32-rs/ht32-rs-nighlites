...
#[doc = "Reader of field `CSIFMPRE`"]
pub type CSIFMPRE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `CSIFMPRE`"]
pub struct CSIFMPRE_W<'a> {
    w: &'a mut W,
}
impl<'a> CSIFMPRE_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl W {
    ...
    #[doc = "Bits 24:28 - CSIFMPRE"]
    #[inline(always)]
    pub fn csifmpre(&mut self) -> CSIFMPRE_W {
        CSIFMPRE_W { w: self }
    }
    #[doc = "Bits 29:31 - LPMOD"]
    #[inline(always)]
