#[doc = "Reader of register UART0_FCR"]
pub type R = crate::R<u32, super::UART0_FCR>;
#[doc = "Writer for register UART0_FCR"]
pub type W = crate::W<u32, super::UART0_FCR>;
#[doc = "Register UART0_FCR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART0_FCR {
    type Type = u32;
    #[inline(always)]
