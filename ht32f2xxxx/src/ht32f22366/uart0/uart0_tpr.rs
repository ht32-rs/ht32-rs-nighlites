#[doc = "Reader of register UART0_TPR"]
pub type R = crate::R<u32, super::UART0_TPR>;
#[doc = "Writer for register UART0_TPR"]
pub type W = crate::W<u32, super::UART0_TPR>;
#[doc = "Register UART0_TPR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART0_TPR {
    type Type = u32;
    #[inline(always)]
