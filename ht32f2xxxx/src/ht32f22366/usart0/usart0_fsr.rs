#[doc = "Reader of register USART0_FSR"]
pub type R = crate::R<u32, super::USART0_FSR>;
#[doc = "Writer for register USART0_FSR"]
pub type W = crate::W<u32, super::USART0_FSR>;
#[doc = "Register USART0_FSR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART0_FSR {
    type Type = u32;
    #[inline(always)]
