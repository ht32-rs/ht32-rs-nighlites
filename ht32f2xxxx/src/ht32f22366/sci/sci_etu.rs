#[doc = "Reader of register SCI_ETU"]
pub type R = crate::R<u32, super::SCI_ETU>;
#[doc = "Writer for register SCI_ETU"]
pub type W = crate::W<u32, super::SCI_ETU>;
#[doc = "Register SCI_ETU `reset()`'s with value 0"]
impl crate::ResetValue for super::SCI_ETU {
    type Type = u32;
    #[inline(always)]
