...
#[doc = "Field `ADAL3` reader - ADAL3"]
pub type ADAL3_R = crate::BitReader;
#[doc = "Field `ADAL3` writer - ADAL3"]
pub type ADAL3_W<'a, const O: u8> = crate::BitWriter<'a, ADC_OFR3_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 14 - ADAL3"]
    #[inline(always)]
    pub fn adal3(&self) -> ADAL3_R {
        ADAL3_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - ADOFE3"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adal3(&mut self) -> ADAL3_W<14> {
        ADAL3_W::new(self)
    }
    #[doc = "Bit 15 - ADOFE3"]
    #[inline(always)]
