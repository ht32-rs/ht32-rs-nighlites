#[doc = "Reader of register CMP_IER0"]
pub type R = crate::R<u32, super::CMP_IER0>;
#[doc = "Writer for register CMP_IER0"]
pub type W = crate::W<u32, super::CMP_IER0>;
#[doc = "Register CMP_IER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP_IER0 {
    type Type = u32;
    #[inline(always)]
