...
pub type RFTLI_RTOIE_W<'a, const O: u8> = crate::BitWriter<'a, UART1_IER_SPEC, O>;
#[doc = "Field `TFTLIE` reader - TFTLIE"]
pub type TFTLIE_R = crate::BitReader;
#[doc = "Field `TFTLIE` writer - TFTLIE"]
pub type TFTLIE_W<'a, const O: u8> = crate::BitWriter<'a, UART1_IER_SPEC, O>;
#[doc = "Field `RLSIE` reader - RLSIE"]
pub type RLSIE_R = crate::BitReader;
#[doc = "Field `RLSIE` writer - RLSIE"]
pub type RLSIE_W<'a, const O: u8> = crate::BitWriter<'a, UART1_IER_SPEC, O>;
impl R {
...
#[doc = "`read()` method returns [uart1_ier::R](R) reader structure"]
impl crate::Readable for UART1_IER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart1_ier::W](W) writer structure"]
impl crate::Writable for UART1_IER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART1_IER to value 0"]
