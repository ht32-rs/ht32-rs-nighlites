...
#[doc = "Register `UART1_RBR` writer"]
pub struct W(crate::W<UART1_RBR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART1_RBR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART1_RBR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART1_RBR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RD_W<'a, const O: u8> = crate::FieldWriter<'a, UART1_RBR_SPEC, 9, O, u16>;
impl R {
    #[doc = "Bits 0:8 - RD"]
    #[inline(always)]
    pub fn rd(&self) -> RD_R {
...
#[doc = "`read()` method returns [uart1_rbr::R](R) reader structure"]
impl crate::Readable for UART1_RBR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart1_rbr::W](W) writer structure"]
impl crate::Writable for UART1_RBR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART1_RBR to value 0"]
