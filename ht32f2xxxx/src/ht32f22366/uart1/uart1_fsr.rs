#[doc = "Reader of register UART1_FSR"]
pub type R = crate::R<u32, super::UART1_FSR>;
#[doc = "Writer for register UART1_FSR"]
pub type W = crate::W<u32, super::UART1_FSR>;
#[doc = "Register UART1_FSR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART1_FSR {
    type Type = u32;
    #[inline(always)]
