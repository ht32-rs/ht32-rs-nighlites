#[doc = "Reader of register EXTI_CFGR2"]
pub type R = crate::R<u32, super::EXTI_CFGR2>;
#[doc = "Writer for register EXTI_CFGR2"]
pub type W = crate::W<u32, super::EXTI_CFGR2>;
#[doc = "Register EXTI_CFGR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR2 {
    type Type = u32;
    #[inline(always)]
