#[doc = "Reader of register CKCU_APBPCSR0"]
pub type R = crate::R<u32, super::CKCU_APBPCSR0>;
#[doc = "Writer for register CKCU_APBPCSR0"]
pub type W = crate::W<u32, super::CKCU_APBPCSR0>;
#[doc = "Register CKCU_APBPCSR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CKCU_APBPCSR0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `MCTM1PCLK`"]
pub type MCTM1PCLK_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `MCTM1PCLK`"]
pub struct MCTM1PCLK_W<'a> {
    w: &'a mut W,
}
impl<'a> MCTM1PCLK_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    pub fn mctm1pclk(&self) -> MCTM1PCLK_R {
        MCTM1PCLK_R::new(((self.bits >> 18) & 0x03) as u8)
    }
