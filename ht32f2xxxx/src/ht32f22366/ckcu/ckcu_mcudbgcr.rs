...
#[doc = "Reader of field `DBMCTM1`"]
pub type DBMCTM1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DBMCTM1`"]
pub struct DBMCTM1_W<'a> {
    w: &'a mut W,
}
impl<'a> DBMCTM1_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `DBSCI`"]
pub type DBSCI_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DBSCI`"]
pub struct DBSCI_W<'a> {
    w: &'a mut W,
}
impl<'a> DBSCI_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn dbmctm1(&self) -> DBMCTM1_R {
        DBMCTM1_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - DBGPTM0"]
    #[inline(always)]
    ...
    pub fn dbsci(&self) -> DBSCI_R {
        DBSCI_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bit 16 - DBBFTM0"]
    #[inline(always)]
