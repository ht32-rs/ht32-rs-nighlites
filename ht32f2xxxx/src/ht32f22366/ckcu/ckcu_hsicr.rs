#[doc = "Reader of register CKCU_HSICR"]
pub type R = crate::R<u32, super::CKCU_HSICR>;
#[doc = "Writer for register CKCU_HSICR"]
pub type W = crate::W<u32, super::CKCU_HSICR>;
#[doc = "Register CKCU_HSICR `reset()`'s with value 0"]
impl crate::ResetValue for super::CKCU_HSICR {
    type Type = u32;
    #[inline(always)]
...
pub type REFCLKSEL_R = crate::R<u8, u8>;
...
impl R {
    ...
    pub fn refclksel(&self) -> REFCLKSEL_R {
        REFCLKSEL_R::new(((self.bits >> 5) & 0x03) as u8)
    }
    #[doc = "Bit 7 - FLOCK"]
    #[inline(always)]
