...
pub type VMCB_R = crate::FieldReader;
#[doc = "Field `VMCB` writer - VMCB"]
pub type VMCB_W<'a, const O: u8> = crate::FieldWriter<'a, FMC_VMCR_SPEC, 2, O>;
impl R {
    #[doc = "Bits 0:1 - VMCB"]
    #[inline(always)]
    pub fn vmcb(&self) -> VMCB_R {
        VMCB_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - VMCB"]
