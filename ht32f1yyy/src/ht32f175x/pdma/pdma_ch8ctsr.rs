#[doc = "Reader of register PDMA_CH8CTSR"]
pub type R = crate::R<u32, super::PDMA_CH8CTSR>;
#[doc = "Writer for register PDMA_CH8CTSR"]
pub type W = crate::W<u32, super::PDMA_CH8CTSR>;
#[doc = "Register PDMA_CH8CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH8CTSR {
    type Type = u32;
    #[inline(always)]
