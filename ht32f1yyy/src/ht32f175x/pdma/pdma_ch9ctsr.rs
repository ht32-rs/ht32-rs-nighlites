#[doc = "Reader of register PDMA_CH9CTSR"]
pub type R = crate::R<u32, super::PDMA_CH9CTSR>;
#[doc = "Writer for register PDMA_CH9CTSR"]
pub type W = crate::W<u32, super::PDMA_CH9CTSR>;
#[doc = "Register PDMA_CH9CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH9CTSR {
    type Type = u32;
    #[inline(always)]
