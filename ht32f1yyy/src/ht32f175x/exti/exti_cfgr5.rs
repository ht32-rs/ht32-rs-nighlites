#[doc = "Reader of register EXTI_CFGR5"]
pub type R = crate::R<u32, super::EXTI_CFGR5>;
#[doc = "Writer for register EXTI_CFGR5"]
pub type W = crate::W<u32, super::EXTI_CFGR5>;
#[doc = "Register EXTI_CFGR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR5 {
    type Type = u32;
    #[inline(always)]
