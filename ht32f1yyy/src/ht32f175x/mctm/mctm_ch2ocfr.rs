#[doc = "Reader of register MCTM_CH2OCFR"]
pub type R = crate::R<u32, super::MCTM_CH2OCFR>;
#[doc = "Writer for register MCTM_CH2OCFR"]
pub type W = crate::W<u32, super::MCTM_CH2OCFR>;
#[doc = "Register MCTM_CH2OCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCTM_CH2OCFR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `REF2CE`"]
pub type REF2CE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `REF2CE`"]
pub struct REF2CE_W<'a> {
    w: &'a mut W,
}
impl<'a> REF2CE_W<'a> {
...
impl R {
    ...
    pub fn ref2ce(&self) -> REF2CE_R {
        REF2CE_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - CH2PRE"]
    #[inline(always)]
