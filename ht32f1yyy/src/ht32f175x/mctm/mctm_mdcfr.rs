#[doc = "Reader of register MCTM_MDCFR"]
pub type R = crate::R<u32, super::MCTM_MDCFR>;
#[doc = "Writer for register MCTM_MDCFR"]
pub type W = crate::W<u32, super::MCTM_MDCFR>;
#[doc = "Register MCTM_MDCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCTM_MDCFR {
    type Type = u32;
    #[inline(always)]
