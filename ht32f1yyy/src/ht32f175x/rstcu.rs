...
#[doc = "RSTCU_GRSR"]
pub mod rstcu_grsr;
#[doc = "RSTCU_AHBPRSTR\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rstcu_ahbprstr](rstcu_ahbprstr) module"]
pub type RSTCU_AHBPRSTR = crate::Reg<u32, _RSTCU_AHBPRSTR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RSTCU_AHBPRSTR;
#[doc = "`read()` method returns [rstcu_ahbprstr::R](rstcu_ahbprstr::R) reader structure"]
impl crate::Readable for RSTCU_AHBPRSTR {}
#[doc = "`write(|w| ..)` method takes [rstcu_ahbprstr::W](rstcu_ahbprstr::W) writer structure"]
impl crate::Writable for RSTCU_AHBPRSTR {}
#[doc = "RSTCU_AHBPRSTR"]
