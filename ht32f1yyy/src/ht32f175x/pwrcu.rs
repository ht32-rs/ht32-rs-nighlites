...
pub struct RegisterBlock {
    ...
    #[doc = "0x0c - PWRCU_HSIRCR"]
    pub pwrcu_hsircr: PWRCU_HSIRCR,
...
#[doc = "PWRCU_HSIRCR\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwrcu_hsircr](pwrcu_hsircr) module"]
pub type PWRCU_HSIRCR = crate::Reg<u32, _PWRCU_HSIRCR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _PWRCU_HSIRCR;
#[doc = "`read()` method returns [pwrcu_hsircr::R](pwrcu_hsircr::R) reader structure"]
impl crate::Readable for PWRCU_HSIRCR {}
#[doc = "`write(|w| ..)` method takes [pwrcu_hsircr::W](pwrcu_hsircr::W) writer structure"]
impl crate::Writable for PWRCU_HSIRCR {}
#[doc = "PWRCU_HSIRCR"]
pub mod pwrcu_hsircr;
