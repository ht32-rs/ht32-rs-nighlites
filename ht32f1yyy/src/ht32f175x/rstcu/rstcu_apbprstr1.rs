...
#[doc = "Field `MCTMRST` reader - MCTMRST"]
pub type MCTMRST_R = crate::BitReader;
#[doc = "Field `MCTMRST` writer - MCTMRST"]
pub type MCTMRST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR1_SPEC, O>;
...
pub type USBRST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR1_SPEC, O>;
...
impl R {
    #[doc = "Bit 0 - MCTMRST"]
    #[inline(always)]
    pub fn mctmrst(&self) -> MCTMRST_R {
        MCTMRST_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mctmrst(&mut self) -> MCTMRST_W<0> {
        MCTMRST_W::new(self)
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbrst(&mut self) -> USBRST_W<14> {
        USBRST_W::new(self)
    }
    #[doc = "Bit 16 - BFTM0RST"]
    #[inline(always)]
