...
#[doc = "Reader of field `MCTMRST`"]
pub type MCTMRST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `MCTMRST`"]
pub struct MCTMRST_W<'a> {
    w: &'a mut W,
}
impl<'a> MCTMRST_W<'a> {
...
impl R {
    ...
    pub fn mctmrst(&self) -> MCTMRST_R {
        MCTMRST_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
    ...
    pub fn usbrst(&self) -> USBRST_R {
        USBRST_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    #[doc = "Bit 16 - BFTM0RST"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - MCTMRST"]
    #[inline(always)]
    pub fn mctmrst(&mut self) -> MCTMRST_W {
        MCTMRST_W { w: self }
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
