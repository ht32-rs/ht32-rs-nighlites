#[doc = "Reader of register GPTM_CH3OCFR"]
pub type R = crate::R<u32, super::GPTM_CH3OCFR>;
#[doc = "Writer for register GPTM_CH3OCFR"]
pub type W = crate::W<u32, super::GPTM_CH3OCFR>;
#[doc = "Register GPTM_CH3OCFR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTM_CH3OCFR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `REF3CE`"]
pub type REF3CE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `REF3CE`"]
pub struct REF3CE_W<'a> {
    w: &'a mut W,
}
impl<'a> REF3CE_W<'a> {
...
impl R {
    ...
    pub fn ref3ce(&self) -> REF3CE_R {
        REF3CE_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - CH3PRE"]
    #[inline(always)]
