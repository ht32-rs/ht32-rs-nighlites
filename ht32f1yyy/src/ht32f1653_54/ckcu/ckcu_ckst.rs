...
pub type HSEST_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_CKST_SPEC, 2, O>;
#[doc = "Field `HSIST` reader - HSIST"]
pub type HSIST_R = crate::FieldReader;
#[doc = "Field `HSIST` writer - HSIST"]
pub type HSIST_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_CKST_SPEC, 3, O>;
#[doc = "Field `CKSWST` reader - CKSWST"]
pub type CKSWST_R = crate::FieldReader;
#[doc = "Field `CKSWST` writer - CKSWST"]
pub type CKSWST_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_CKST_SPEC, 2, O>;
impl R {
    #[doc = "Bits 8:11 - PLLST"]
    #[inline(always)]
    ...
    pub fn ckswst(&self) -> CKSWST_R {
        CKSWST_R::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 8:11 - PLLST"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckswst(&mut self) -> CKSWST_W<30> {
        CKSWST_W::new(self)
    }
