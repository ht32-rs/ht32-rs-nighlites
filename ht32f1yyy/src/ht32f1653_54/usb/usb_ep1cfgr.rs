#[doc = "Reader of register USB_EP1CFGR"]
pub type R = crate::R<u32, super::USB_EP1CFGR>;
#[doc = "Writer for register USB_EP1CFGR"]
pub type W = crate::W<u32, super::USB_EP1CFGR>;
#[doc = "Register USB_EP1CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_EP1CFGR {
    type Type = u32;
    #[inline(always)]
