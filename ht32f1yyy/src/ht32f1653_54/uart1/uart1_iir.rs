#[doc = "Reader of register UART1_IIR"]
pub type R = crate::R<u32, super::UART1_IIR>;
#[doc = "Writer for register UART1_IIR"]
pub type W = crate::W<u32, super::UART1_IIR>;
#[doc = "Register UART1_IIR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART1_IIR {
    type Type = u32;
    #[inline(always)]
