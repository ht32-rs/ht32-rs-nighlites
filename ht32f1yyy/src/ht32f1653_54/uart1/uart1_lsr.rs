...
#[doc = "Register `UART1_LSR` writer"]
pub struct W(crate::W<UART1_LSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART1_LSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART1_LSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART1_LSR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`read()` method returns [uart1_lsr::R](R) reader structure"]
impl crate::Readable for UART1_LSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart1_lsr::W](W) writer structure"]
impl crate::Writable for UART1_LSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART1_LSR to value 0"]
