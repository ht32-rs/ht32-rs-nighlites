#[doc = "Reader of register PDMA_CH2TSR"]
pub type R = crate::R<u32, super::PDMA_CH2TSR>;
#[doc = "Writer for register PDMA_CH2TSR"]
pub type W = crate::W<u32, super::PDMA_CH2TSR>;
#[doc = "Register PDMA_CH2TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH2TSR {
    type Type = u32;
    #[inline(always)]
