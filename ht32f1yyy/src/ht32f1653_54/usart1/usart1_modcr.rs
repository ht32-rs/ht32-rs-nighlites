#[doc = "Reader of register USART1_MODCR"]
pub type R = crate::R<u32, super::USART1_MODCR>;
#[doc = "Writer for register USART1_MODCR"]
pub type W = crate::W<u32, super::USART1_MODCR>;
#[doc = "Register USART1_MODCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART1_MODCR {
    type Type = u32;
    #[inline(always)]
