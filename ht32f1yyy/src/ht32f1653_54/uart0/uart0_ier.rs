#[doc = "Reader of register UART0_IER"]
pub type R = crate::R<u32, super::UART0_IER>;
#[doc = "Writer for register UART0_IER"]
pub type W = crate::W<u32, super::UART0_IER>;
#[doc = "Register UART0_IER `reset()`'s with value 0"]
impl crate::ResetValue for super::UART0_IER {
    type Type = u32;
    #[inline(always)]
