#[doc = "Reader of register USART0_SYNCR"]
pub type R = crate::R<u32, super::USART0_SYNCR>;
#[doc = "Writer for register USART0_SYNCR"]
pub type W = crate::W<u32, super::USART0_SYNCR>;
#[doc = "Register USART0_SYNCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART0_SYNCR {
    type Type = u32;
    #[inline(always)]
