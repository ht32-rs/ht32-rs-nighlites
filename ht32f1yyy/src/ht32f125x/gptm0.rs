...
#[doc = "GPTM_CHPOLR"]
pub mod gptm_chpolr;
#[doc = "GPTM_ICTR\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gptm_ictr](gptm_ictr) module"]
pub type GPTM_ICTR = crate::Reg<u32, _GPTM_ICTR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _GPTM_ICTR;
#[doc = "`read()` method returns [gptm_ictr::R](gptm_ictr::R) reader structure"]
impl crate::Readable for GPTM_ICTR {}
#[doc = "`write(|w| ..)` method takes [gptm_ictr::W](gptm_ictr::W) writer structure"]
impl crate::Writable for GPTM_ICTR {}
#[doc = "GPTM_ICTR"]
pub mod gptm_ictr;
