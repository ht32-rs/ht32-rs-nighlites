#[doc = "Reader of register EXTI_CFGR1"]
pub type R = crate::R<u32, super::EXTI_CFGR1>;
#[doc = "Writer for register EXTI_CFGR1"]
pub type W = crate::W<u32, super::EXTI_CFGR1>;
#[doc = "Register EXTI_CFGR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR1 {
    type Type = u32;
    #[inline(always)]
