#[doc = "Reader of register EXTI_CFGR6"]
pub type R = crate::R<u32, super::EXTI_CFGR6>;
#[doc = "Writer for register EXTI_CFGR6"]
pub type W = crate::W<u32, super::EXTI_CFGR6>;
#[doc = "Register EXTI_CFGR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR6 {
    type Type = u32;
    #[inline(always)]
