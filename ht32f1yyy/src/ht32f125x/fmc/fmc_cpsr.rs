#[doc = "Reader of register FMC_CPSR"]
pub type R = crate::R<u32, super::FMC_CPSR>;
#[doc = "Writer for register FMC_CPSR"]
pub type W = crate::W<u32, super::FMC_CPSR>;
#[doc = "Register FMC_CPSR `reset()`'s with value 0"]
impl crate::ResetValue for super::FMC_CPSR {
    type Type = u32;
    #[inline(always)]
