...
#[doc = "Field `IPSE` reader - IPSE"]
pub type IPSE_R = crate::BitReader;
#[doc = "Field `IPSE` writer - IPSE"]
pub type IPSE_W<'a, const O: u8> = crate::BitWriter<'a, FMC_CFCR_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - WAIT"]
    #[inline(always)]
