#[doc = "Reader of register USART_MODCR"]
pub type R = crate::R<u32, super::USART_MODCR>;
#[doc = "Writer for register USART_MODCR"]
pub type W = crate::W<u32, super::USART_MODCR>;
#[doc = "Register USART_MODCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART_MODCR {
    type Type = u32;
    #[inline(always)]
