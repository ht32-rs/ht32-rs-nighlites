#[doc = "Reader of register USART_TPR"]
pub type R = crate::R<u32, super::USART_TPR>;
#[doc = "Writer for register USART_TPR"]
pub type W = crate::W<u32, super::USART_TPR>;
#[doc = "Register USART_TPR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART_TPR {
    type Type = u32;
    #[inline(always)]
