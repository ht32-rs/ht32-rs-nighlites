#[doc = "Register `USART_LSR` reader"]
pub struct R(crate::R<USART_LSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USART_LSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USART_LSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USART_LSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USART_LSR` writer"]
pub struct W(crate::W<USART_LSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USART_LSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USART_LSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USART_LSR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "USART_LSR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usart_lsr](index.html) module"]
pub struct USART_LSR_SPEC;
impl crate::RegisterSpec for USART_LSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usart_lsr::R](R) reader structure"]
impl crate::Readable for USART_LSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usart_lsr::W](W) writer structure"]
impl crate::Writable for USART_LSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USART_LSR to value 0"]
impl crate::Resettable for USART_LSR_SPEC {
