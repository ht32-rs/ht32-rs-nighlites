#[doc = "Reader of register USART0_IIR"]
pub type R = crate::R<u32, super::USART0_IIR>;
#[doc = "Writer for register USART0_IIR"]
pub type W = crate::W<u32, super::USART0_IIR>;
#[doc = "Register USART0_IIR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART0_IIR {
    type Type = u32;
    #[inline(always)]
