#[doc = "Reader of register PDMA_CH2CTSR"]
pub type R = crate::R<u32, super::PDMA_CH2CTSR>;
#[doc = "Writer for register PDMA_CH2CTSR"]
pub type W = crate::W<u32, super::PDMA_CH2CTSR>;
#[doc = "Register PDMA_CH2CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH2CTSR {
    type Type = u32;
    #[inline(always)]
