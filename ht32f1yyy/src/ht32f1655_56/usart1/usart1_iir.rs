#[doc = "Reader of register USART1_IIR"]
pub type R = crate::R<u32, super::USART1_IIR>;
#[doc = "Writer for register USART1_IIR"]
pub type W = crate::W<u32, super::USART1_IIR>;
#[doc = "Register USART1_IIR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART1_IIR {
    type Type = u32;
    #[inline(always)]
