...
#[doc = "Field `ADAL5` reader - ADAL5"]
pub type ADAL5_R = crate::BitReader;
#[doc = "Field `ADAL5` writer - ADAL5"]
pub type ADAL5_W<'a, const O: u8> = crate::BitWriter<'a, ADC_OFR5_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adal5(&mut self) -> ADAL5_W<14> {
        ADAL5_W::new(self)
    }
    #[doc = "Bit 15 - ADOFE5"]
    #[inline(always)]
