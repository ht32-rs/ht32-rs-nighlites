...
#[doc = "Field `ADAL0` reader - ADAL0"]
pub type ADAL0_R = crate::BitReader;
#[doc = "Field `ADAL0` writer - ADAL0"]
pub type ADAL0_W<'a, const O: u8> = crate::BitWriter<'a, ADC_OFR0_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adal0(&mut self) -> ADAL0_W<14> {
        ADAL0_W::new(self)
    }
    #[doc = "Bit 15 - ADOFE0"]
    #[inline(always)]
