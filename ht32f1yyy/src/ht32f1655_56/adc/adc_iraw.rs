#[doc = "Reader of register ADC_IRAW"]
pub type R = crate::R<u32, super::ADC_IRAW>;
#[doc = "Writer for register ADC_IRAW"]
pub type W = crate::W<u32, super::ADC_IRAW>;
#[doc = "Register ADC_IRAW `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_IRAW {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `ADIRAWHS`"]
pub type ADIRAWHS_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ADIRAWHS`"]
pub struct ADIRAWHS_W<'a> {
    w: &'a mut W,
}
impl<'a> ADIRAWHS_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `ADIRAWHG`"]
pub type ADIRAWHG_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ADIRAWHG`"]
pub struct ADIRAWHG_W<'a> {
    w: &'a mut W,
}
impl<'a> ADIRAWHG_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `ADIRAWHC`"]
pub type ADIRAWHC_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ADIRAWHC`"]
pub struct ADIRAWHC_W<'a> {
    w: &'a mut W,
}
impl<'a> ADIRAWHC_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `ADIRAWHO`"]
pub type ADIRAWHO_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ADIRAWHO`"]
pub struct ADIRAWHO_W<'a> {
    w: &'a mut W,
}
impl<'a> ADIRAWHO_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn adirawhs(&self) -> ADIRAWHS_R {
        ADIRAWHS_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - ADIRAWHG"]
    #[inline(always)]
    pub fn adirawhg(&self) -> ADIRAWHG_R {
        ADIRAWHG_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - ADIRAWHC"]
    #[inline(always)]
    pub fn adirawhc(&self) -> ADIRAWHC_R {
        ADIRAWHC_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 16 - ADIRAWL"]
    #[inline(always)]
    ...
    pub fn adirawho(&self) -> ADIRAWHO_R {
        ADIRAWHO_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - ADIRAWS"]
