...
#[doc = "`read()` method returns [uart0_lcr::R](R) reader structure"]
impl crate::Readable for UART0_LCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart0_lcr::W](W) writer structure"]
impl crate::Writable for UART0_LCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART0_LCR to value 0"]
