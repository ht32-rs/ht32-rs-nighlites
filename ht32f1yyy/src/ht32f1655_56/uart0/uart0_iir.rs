#[doc = "Reader of register UART0_IIR"]
pub type R = crate::R<u32, super::UART0_IIR>;
#[doc = "Writer for register UART0_IIR"]
pub type W = crate::W<u32, super::UART0_IIR>;
#[doc = "Register UART0_IIR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART0_IIR {
    type Type = u32;
    #[inline(always)]
