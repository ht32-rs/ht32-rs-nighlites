#[doc = "Reader of register MCTM_CH0ICFR"]
pub type R = crate::R<u32, super::MCTM_CH0ICFR>;
#[doc = "Writer for register MCTM_CH0ICFR"]
pub type W = crate::W<u32, super::MCTM_CH0ICFR>;
#[doc = "Register MCTM_CH0ICFR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCTM_CH0ICFR {
    type Type = u32;
    #[inline(always)]
