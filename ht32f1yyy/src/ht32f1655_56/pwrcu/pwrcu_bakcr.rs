...
#[doc = "Reader of field `V18RDYSC`"]
pub type V18RDYSC_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `V18RDYSC`"]
pub struct V18RDYSC_W<'a> {
    w: &'a mut W,
}
impl<'a> V18RDYSC_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn v18rdysc(&self) -> V18RDYSC_R {
        V18RDYSC_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    #[doc = "Bit 15 - DMOSSTS"]
    #[inline(always)]
