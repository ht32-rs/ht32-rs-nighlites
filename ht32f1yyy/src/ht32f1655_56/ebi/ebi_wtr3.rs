#[doc = "Reader of register EBI_WTR3"]
pub type R = crate::R<u32, super::EBI_WTR3>;
#[doc = "Writer for register EBI_WTR3"]
pub type W = crate::W<u32, super::EBI_WTR3>;
#[doc = "Register EBI_WTR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_WTR3 {
    type Type = u32;
    #[inline(always)]
