#[doc = "Reader of register UART1_TPR"]
pub type R = crate::R<u32, super::UART1_TPR>;
#[doc = "Writer for register UART1_TPR"]
pub type W = crate::W<u32, super::UART1_TPR>;
#[doc = "Register UART1_TPR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART1_TPR {
    type Type = u32;
    #[inline(always)]
