...
pub type MCTM0RST_R = crate::BitReader;
#[doc = "Field `MCTM0RST` writer - MCTM0RST"]
pub type MCTM0RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR1_SPEC, O>;
#[doc = "Field `MCTM1RST` reader - MCTM1RST"]
pub type MCTM1RST_R = crate::BitReader;
#[doc = "Field `MCTM1RST` writer - MCTM1RST"]
pub type MCTM1RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR1_SPEC, O>;
...
impl R {
    ...
    pub fn mctm1rst(&self) -> MCTM1RST_R {
        MCTM1RST_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mctm1rst(&mut self) -> MCTM1RST_W<1> {
        MCTM1RST_W::new(self)
    }
    #[doc = "Bit 4 - WDTRST"]
    #[inline(always)]
