...
pub type TXDMAE_W<'a, const O: u8> = crate::BitWriter<'a, SPI_CR0_SPEC, O>;
#[doc = "Field `RXDMAE` reader - RXDMAE"]
pub type RXDMAE_R = crate::BitReader;
#[doc = "Field `RXDMAE` writer - RXDMAE"]
pub type RXDMAE_W<'a, const O: u8> = crate::BitWriter<'a, SPI_CR0_SPEC, O>;
