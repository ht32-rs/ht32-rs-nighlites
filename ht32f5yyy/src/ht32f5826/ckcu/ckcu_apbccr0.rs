...
pub type USR0EN_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_APBCCR0_SPEC, O>;
#[doc = "Field `USR1EN` reader - USR1EN"]
pub type USR1EN_R = crate::BitReader;
#[doc = "Field `USR1EN` writer - USR1EN"]
pub type USR1EN_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_APBCCR0_SPEC, O>;
...
pub type SCI0EN_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_APBCCR0_SPEC, O>;
...
pub type SCI1EN_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_APBCCR0_SPEC, O>;
impl R {
    #[doc = "Bit 0 - I2C0EN"]
    #[inline(always)]
