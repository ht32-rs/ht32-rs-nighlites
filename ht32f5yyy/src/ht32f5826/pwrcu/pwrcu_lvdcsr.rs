...
pub type BODEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `BODRIS` reader - BODRIS"]
pub type BODRIS_R = crate::BitReader;
#[doc = "Field `BODRIS` writer - BODRIS"]
pub type BODRIS_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `BODF` reader - BODF"]
pub type BODF_R = crate::BitReader;
#[doc = "Field `BODF` writer - BODF"]
pub type BODF_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `LVDEN` reader - LVDEN"]
pub type LVDEN_R = crate::BitReader;
#[doc = "Field `LVDEN` writer - LVDEN"]
pub type LVDEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `LVDS10` reader - LVDS\\[1:0\\]"]
pub type LVDS10_R = crate::FieldReader;
#[doc = "Field `LVDS10` writer - LVDS\\[1:0\\]"]
pub type LVDS10_W<'a, const O: u8> = crate::FieldWriter<'a, PWRCU_LVDCSR_SPEC, 2, O>;
#[doc = "Field `LVDF` reader - LVDF"]
pub type LVDF_R = crate::BitReader;
#[doc = "Field `LVDF` writer - LVDF"]
pub type LVDF_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `LVDIWEN` reader - LVDIWEN"]
pub type LVDIWEN_R = crate::BitReader;
#[doc = "Field `LVDIWEN` writer - LVDIWEN"]
pub type LVDIWEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `LVDEWEN` reader - LVDEWEN"]
pub type LVDEWEN_R = crate::BitReader;
#[doc = "Field `LVDEWEN` writer - LVDEWEN"]
pub type LVDEWEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
#[doc = "Field `LVDS2` reader - LVDS2"]
pub type LVDS2_R = crate::BitReader;
#[doc = "Field `LVDS2` writer - LVDS2"]
pub type LVDS2_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_LVDCSR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - BODEN"]
    #[inline(always)]
