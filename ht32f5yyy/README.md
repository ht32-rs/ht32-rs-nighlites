...
# ht32f5yyy
This crate provides an autogenerated API for access to HT32F5YYY peripherals.
...
[documentation]: https://docs.rs/ht32f5yyy/latest/ht32f5yyy/
...
```toml
[dependencies.ht32f5yyy]
version = "0.2.0"
features = ["ht32f5826", "rt"]
```
...
```rust
use ht32f5yyy::ht32f5826;

let mut peripherals = ht32f5826::Peripherals::take().unwrap();
...
|:------:|:-------:|:-----:|
| ht32f5826 | TODO | [TODO](TODO), [st.com](TODO) |
