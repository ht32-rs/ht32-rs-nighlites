...
#[doc = "Field `VDDRPCLK` reader - VDDRPCLK"]
pub type VDDRPCLK_R = crate::FieldReader;
#[doc = "Field `VDDRPCLK` writer - VDDRPCLK"]
pub type VDDRPCLK_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_APBPCSR1_SPEC, 2, O>;
#[doc = "Field `SCI0PCLK` reader - SCI0PCLK"]
pub type SCI0PCLK_R = crate::FieldReader;
#[doc = "Field `SCI0PCLK` writer - SCI0PCLK"]
pub type SCI0PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_APBPCSR1_SPEC, 2, O>;
#[doc = "Field `SCI1PCLK` reader - SCI1PCLK"]
pub type SCI1PCLK_R = crate::FieldReader;
#[doc = "Field `SCI1PCLK` writer - SCI1PCLK"]
pub type SCI1PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_APBPCSR1_SPEC, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 14:15 - VDDRPCLK"]
    #[inline(always)]
    pub fn vddrpclk(&self) -> VDDRPCLK_R {
        VDDRPCLK_R::new(((self.bits >> 14) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vddrpclk(&mut self) -> VDDRPCLK_W<14> {
        VDDRPCLK_W::new(self)
    }
    #[doc = "Bits 16:17 - SCI0PCLK"]
    #[inline(always)]
