...
#[doc = "Field `LCDCPS` reader - LCDCPS"]
pub type LCDCPS_R = crate::FieldReader;
#[doc = "Field `LCDCPS` writer - LCDCPS"]
pub type LCDCPS_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_APBCFGR_SPEC, 3, O>;
...
impl R {
    #[doc = "Bits 8:10 - LCDCPS"]
    #[inline(always)]
    pub fn lcdcps(&self) -> LCDCPS_R {
        LCDCPS_R::new(((self.bits >> 8) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcdcps(&mut self) -> LCDCPS_W<8> {
        LCDCPS_W::new(self)
    }
    #[doc = "Bits 16:18 - ADCDIV"]
    #[inline(always)]
