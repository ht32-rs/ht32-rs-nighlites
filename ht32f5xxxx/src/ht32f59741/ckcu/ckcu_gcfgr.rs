...
#[doc = "Field `LCDSRC` reader - LCDSRC"]
pub type LCDSRC_R = crate::FieldReader;
#[doc = "Field `LCDSRC` writer - LCDSRC"]
pub type LCDSRC_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_GCFGR_SPEC, 2, O>;
...
#[doc = "Field `USBPLLSRC` reader - USBPLLSRC"]
pub type USBPLLSRC_R = crate::BitReader;
#[doc = "Field `USBPLLSRC` writer - USBPLLSRC"]
pub type USBPLLSRC_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_GCFGR_SPEC, O>;
#[doc = "Field `USBSRC` reader - USBSRC"]
pub type USBSRC_R = crate::BitReader;
#[doc = "Field `USBSRC` writer - USBSRC"]
pub type USBSRC_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_GCFGR_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bits 4:5 - LCDSRC"]
    #[inline(always)]
    pub fn lcdsrc(&self) -> LCDSRC_R {
        LCDSRC_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bit 8 - PLLSRC"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - USBPLLSRC"]
    #[inline(always)]
    pub fn usbpllsrc(&self) -> USBPLLSRC_R {
        USBPLLSRC_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - USBSRC"]
    #[inline(always)]
    pub fn usbsrc(&self) -> USBSRC_R {
        USBSRC_R::new(((self.bits >> 10) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcdsrc(&mut self) -> LCDSRC_W<4> {
        LCDSRC_W::new(self)
    }
    #[doc = "Bit 8 - PLLSRC"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbpllsrc(&mut self) -> USBPLLSRC_W<9> {
        USBPLLSRC_W::new(self)
    }
    #[doc = "Bit 10 - USBSRC"]
    #[inline(always)]
    #[must_use]
    pub fn usbsrc(&mut self) -> USBSRC_W<10> {
        USBSRC_W::new(self)
    }
    #[doc = "Bits 11:15 - CKREFPRE"]
    #[inline(always)]
