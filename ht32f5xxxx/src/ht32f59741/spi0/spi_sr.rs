...
pub struct W(crate::W<SPI_SR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_SR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_SR_SPEC>) -> Self {
        W(writer)
    }
}
