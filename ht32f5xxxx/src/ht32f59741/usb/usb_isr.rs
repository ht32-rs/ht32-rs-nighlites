...
pub struct R(crate::R<USB_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB_ISR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USB_ISR` writer"]
pub struct W(crate::W<USB_ISR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB_ISR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB_ISR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SOFIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `URSTIF` reader - URSTIF"]
pub type URSTIF_R = crate::BitReader;
#[doc = "Field `URSTIF` writer - URSTIF"]
pub type URSTIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `RSMIF` reader - RSMIF"]
pub type RSMIF_R = crate::BitReader;
#[doc = "Field `RSMIF` writer - RSMIF"]
pub type RSMIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `SUSPIF` reader - SUSPIF"]
pub type SUSPIF_R = crate::BitReader;
#[doc = "Field `SUSPIF` writer - SUSPIF"]
pub type SUSPIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `ESOFIF` reader - ESOFIF"]
pub type ESOFIF_R = crate::BitReader;
#[doc = "Field `ESOFIF` writer - ESOFIF"]
pub type ESOFIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `FRESIF` reader - FRESIF"]
pub type FRESIF_R = crate::BitReader;
#[doc = "Field `FRESIF` writer - FRESIF"]
pub type FRESIF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP0IF` reader - EP0IF"]
pub type EP0IF_R = crate::BitReader;
#[doc = "Field `EP0IF` writer - EP0IF"]
pub type EP0IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP1IF` reader - EP1IF"]
pub type EP1IF_R = crate::BitReader;
#[doc = "Field `EP1IF` writer - EP1IF"]
pub type EP1IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP2IF` reader - EP2IF"]
pub type EP2IF_R = crate::BitReader;
#[doc = "Field `EP2IF` writer - EP2IF"]
pub type EP2IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP3IF` reader - EP3IF"]
pub type EP3IF_R = crate::BitReader;
#[doc = "Field `EP3IF` writer - EP3IF"]
pub type EP3IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP4IF` reader - EP4IF"]
pub type EP4IF_R = crate::BitReader;
#[doc = "Field `EP4IF` writer - EP4IF"]
pub type EP4IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP5IF` reader - EP5IF"]
pub type EP5IF_R = crate::BitReader;
#[doc = "Field `EP5IF` writer - EP5IF"]
pub type EP5IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP6IF` reader - EP6IF"]
pub type EP6IF_R = crate::BitReader;
#[doc = "Field `EP6IF` writer - EP6IF"]
pub type EP6IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
#[doc = "Field `EP7IF` reader - EP7IF"]
pub type EP7IF_R = crate::BitReader;
#[doc = "Field `EP7IF` writer - EP7IF"]
pub type EP7IF_W<'a, const O: u8> = crate::BitWriter<'a, USB_ISR_SPEC, O>;
impl R {
    #[doc = "Bit 1 - SOFIF"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - FRESIF"]
    #[inline(always)]
    pub fn fresif(&self) -> FRESIF_R {
        FRESIF_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 8 - EP0IF"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fresif(&mut self) -> FRESIF_W<6> {
        FRESIF_W::new(self)
    }
    #[doc = "Bit 8 - EP0IF"]
    #[inline(always)]
