...
pub type CH0P_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CHPOLR_SPEC, O>;
#[doc = "Field `CH1P` reader - CH1P"]
pub type CH1P_R = crate::BitReader;
#[doc = "Field `CH1P` writer - CH1P"]
pub type CH1P_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CHPOLR_SPEC, O>;
#[doc = "Field `CH2P` reader - CH2P"]
pub type CH2P_R = crate::BitReader;
#[doc = "Field `CH2P` writer - CH2P"]
pub type CH2P_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CHPOLR_SPEC, O>;
#[doc = "Field `CH3P` reader - CH3P"]
pub type CH3P_R = crate::BitReader;
#[doc = "Field `CH3P` writer - CH3P"]
pub type CH3P_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CHPOLR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CH0P"]
    #[inline(always)]
