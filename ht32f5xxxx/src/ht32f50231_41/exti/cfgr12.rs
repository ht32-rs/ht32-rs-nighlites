...
pub struct R(crate::R<CFGR12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CFGR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CFGR12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CFGR12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CFGR12` writer"]
pub struct W(crate::W<CFGR12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CFGR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CFGR12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CFGR12_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DBCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR12_SPEC, 16, O, u16>;
#[doc = "Field `SRCTYPE` reader - SRCTYPE"]
pub type SRCTYPE_R = crate::FieldReader;
#[doc = "Field `SRCTYPE` writer - SRCTYPE"]
pub type SRCTYPE_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR12_SPEC, 3, O>;
#[doc = "Field `DBEN` reader - DBEN"]
pub type DBEN_R = crate::BitReader;
#[doc = "Field `DBEN` writer - DBEN"]
pub type DBEN_W<'a, const O: u8> = crate::BitWriter<'a, CFGR12_SPEC, O>;
impl R {
    #[doc = "Bits 0:15 - DBCNT"]
    #[inline(always)]
...
#[doc = "EXTI_CFGR12\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cfgr12](index.html) module"]
pub struct CFGR12_SPEC;
impl crate::RegisterSpec for CFGR12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cfgr12::R](R) reader structure"]
impl crate::Readable for CFGR12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cfgr12::W](W) writer structure"]
impl crate::Writable for CFGR12_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CFGR12 to value 0"]
impl crate::Resettable for CFGR12_SPEC {
