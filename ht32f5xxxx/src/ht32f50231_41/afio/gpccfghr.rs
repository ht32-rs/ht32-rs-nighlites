#[doc = "Register `GPCCFGHR` reader"]
pub struct R(crate::R<GPCCFGHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPCCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPCCFGHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPCCFGHR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPCCFGHR` writer"]
pub struct W(crate::W<GPCCFGHR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPCCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPCCFGHR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPCCFGHR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPCCFGHR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpccfghr](index.html) module"]
pub struct GPCCFGHR_SPEC;
impl crate::RegisterSpec for GPCCFGHR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpccfghr::R](R) reader structure"]
impl crate::Readable for GPCCFGHR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpccfghr::W](W) writer structure"]
impl crate::Writable for GPCCFGHR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPCCFGHR to value 0"]
impl crate::Resettable for GPCCFGHR_SPEC {
