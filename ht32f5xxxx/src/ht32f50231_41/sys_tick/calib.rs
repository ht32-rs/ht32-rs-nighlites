...
pub type TENMS_W<'a, const O: u8> = crate::FieldWriter<'a, CALIB_SPEC, 24, O, u32>;
#[doc = "Field `SKEW` reader - SKEW"]
pub type SKEW_R = crate::BitReader;
#[doc = "Field `SKEW` writer - SKEW"]
pub type SKEW_W<'a, const O: u8> = crate::BitWriter<'a, CALIB_SPEC, O>;
#[doc = "Field `NOREF` reader - NOREF"]
pub type NOREF_R = crate::BitReader;
#[doc = "Field `NOREF` writer - NOREF"]
pub type NOREF_W<'a, const O: u8> = crate::BitWriter<'a, CALIB_SPEC, O>;
impl R {
    #[doc = "Bits 0:23 - TENMS"]
    #[inline(always)]
