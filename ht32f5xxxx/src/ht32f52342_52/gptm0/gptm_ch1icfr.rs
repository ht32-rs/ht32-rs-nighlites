...
pub type TI1F_W<'a, const O: u8> = crate::FieldWriter<'a, GPTM_CH1ICFR_SPEC, 4, O>;
#[doc = "Field `CH1CCS` reader - CH1CCS"]
pub type CH1CCS_R = crate::FieldReader;
#[doc = "Field `CH1CCS` writer - CH1CCS"]
pub type CH1CCS_W<'a, const O: u8> = crate::FieldWriter<'a, GPTM_CH1ICFR_SPEC, 2, O>;
#[doc = "Field `CH1PSC` reader - CH1PSC"]
pub type CH1PSC_R = crate::FieldReader;
#[doc = "Field `CH1PSC` writer - CH1PSC"]
pub type CH1PSC_W<'a, const O: u8> = crate::FieldWriter<'a, GPTM_CH1ICFR_SPEC, 2, O>;
impl R {
    #[doc = "Bits 0:3 - TI1F"]
    #[inline(always)]
