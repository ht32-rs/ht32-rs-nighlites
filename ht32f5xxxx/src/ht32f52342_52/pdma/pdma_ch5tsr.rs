#[doc = "Reader of register PDMA_CH5TSR"]
pub type R = crate::R<u32, super::PDMA_CH5TSR>;
#[doc = "Writer for register PDMA_CH5TSR"]
pub type W = crate::W<u32, super::PDMA_CH5TSR>;
#[doc = "Register PDMA_CH5TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH5TSR {
    type Type = u32;
    #[inline(always)]
