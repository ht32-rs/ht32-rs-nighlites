#[doc = "Register `PDMA_ISR` reader"]
pub struct R(crate::R<PDMA_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDMA_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PDMA_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PDMA_ISR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PDMA_ISR` writer"]
pub struct W(crate::W<PDMA_ISR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PDMA_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PDMA_ISR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PDMA_ISR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PDMA_ISR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pdma_isr](index.html) module"]
pub struct PDMA_ISR_SPEC;
impl crate::RegisterSpec for PDMA_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pdma_isr::R](R) reader structure"]
impl crate::Readable for PDMA_ISR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pdma_isr::W](W) writer structure"]
impl crate::Writable for PDMA_ISR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PDMA_ISR to value 0"]
impl crate::Resettable for PDMA_ISR_SPEC {
