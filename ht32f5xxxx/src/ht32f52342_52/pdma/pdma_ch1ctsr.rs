#[doc = "Reader of register PDMA_CH1CTSR"]
pub type R = crate::R<u32, super::PDMA_CH1CTSR>;
#[doc = "Writer for register PDMA_CH1CTSR"]
pub type W = crate::W<u32, super::PDMA_CH1CTSR>;
#[doc = "Register PDMA_CH1CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH1CTSR {
    type Type = u32;
    #[inline(always)]
