#[doc = "Reader of register FMC_MDID"]
pub type R = crate::R<u32, super::FMC_MDID>;
#[doc = "Writer for register FMC_MDID"]
pub type W = crate::W<u32, super::FMC_MDID>;
#[doc = "Register FMC_MDID `reset()`'s with value 0"]
impl crate::ResetValue for super::FMC_MDID {
    type Type = u32;
    #[inline(always)]
