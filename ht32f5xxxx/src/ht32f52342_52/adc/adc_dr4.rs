#[doc = "Reader of register ADC_DR4"]
pub type R = crate::R<u32, super::ADC_DR4>;
#[doc = "Writer for register ADC_DR4"]
pub type W = crate::W<u32, super::ADC_DR4>;
#[doc = "Register ADC_DR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_DR4 {
    type Type = u32;
    #[inline(always)]
