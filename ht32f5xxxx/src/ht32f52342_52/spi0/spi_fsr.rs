#[doc = "Reader of register SPI_FSR"]
pub type R = crate::R<u32, super::SPI_FSR>;
#[doc = "Writer for register SPI_FSR"]
pub type W = crate::W<u32, super::SPI_FSR>;
#[doc = "Register SPI_FSR `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_FSR {
    type Type = u32;
    #[inline(always)]
