#[doc = "Reader of register SCI_ETUR"]
pub type R = crate::R<u32, super::SCI_ETUR>;
#[doc = "Writer for register SCI_ETUR"]
pub type W = crate::W<u32, super::SCI_ETUR>;
#[doc = "Register SCI_ETUR `reset()`'s with value 0"]
impl crate::ResetValue for super::SCI_ETUR {
    type Type = u32;
    #[inline(always)]
