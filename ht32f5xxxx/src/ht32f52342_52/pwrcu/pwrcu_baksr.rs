...
pub type BAKPORF_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_BAKSR_SPEC, O>;
#[doc = "Field `PDF` reader - PDF"]
pub type PDF_R = crate::BitReader;
#[doc = "Field `PDF` writer - PDF"]
pub type PDF_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_BAKSR_SPEC, O>;
#[doc = "Field `WUPF` reader - WUPF"]
pub type WUPF_R = crate::BitReader;
#[doc = "Field `WUPF` writer - WUPF"]
pub type WUPF_W<'a, const O: u8> = crate::BitWriter<'a, PWRCU_BAKSR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - BAKPORF"]
    #[inline(always)]
