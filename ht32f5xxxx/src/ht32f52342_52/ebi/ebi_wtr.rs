#[doc = "Reader of register EBI_WTR"]
pub type R = crate::R<u32, super::EBI_WTR>;
#[doc = "Writer for register EBI_WTR"]
pub type W = crate::W<u32, super::EBI_WTR>;
#[doc = "Register EBI_WTR `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_WTR {
    type Type = u32;
    #[inline(always)]
