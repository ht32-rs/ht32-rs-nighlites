#[doc = "Reader of register EBI_RTR"]
pub type R = crate::R<u32, super::EBI_RTR>;
#[doc = "Writer for register EBI_RTR"]
pub type W = crate::W<u32, super::EBI_RTR>;
#[doc = "Register EBI_RTR `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_RTR {
    type Type = u32;
    #[inline(always)]
