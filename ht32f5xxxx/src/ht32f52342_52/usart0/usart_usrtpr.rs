...
pub type RXTOC_W<'a, const O: u8> = crate::FieldWriter<'a, USART_USRTPR_SPEC, 7, O>;
#[doc = "Field `RXTOEN` reader - RXTOEN"]
pub type RXTOEN_R = crate::BitReader;
#[doc = "Field `RXTOEN` writer - RXTOEN"]
pub type RXTOEN_W<'a, const O: u8> = crate::BitWriter<'a, USART_USRTPR_SPEC, O>;
#[doc = "Field `TG` reader - TG"]
pub type TG_R = crate::FieldReader;
#[doc = "Field `TG` writer - TG"]
pub type TG_W<'a, const O: u8> = crate::FieldWriter<'a, USART_USRTPR_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:6 - RXTOC"]
    #[inline(always)]
