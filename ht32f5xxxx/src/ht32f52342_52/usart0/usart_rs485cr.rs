...
pub type RSNMM_W<'a, const O: u8> = crate::BitWriter<'a, USART_RS485CR_SPEC, O>;
#[doc = "Field `RSAAD` reader - RSAAD"]
pub type RSAAD_R = crate::BitReader;
#[doc = "Field `RSAAD` writer - RSAAD"]
pub type RSAAD_W<'a, const O: u8> = crate::BitWriter<'a, USART_RS485CR_SPEC, O>;
#[doc = "Field `ADDMATCH` reader - ADDMATCH"]
pub type ADDMATCH_R = crate::FieldReader;
#[doc = "Field `ADDMATCH` writer - ADDMATCH"]
pub type ADDMATCH_W<'a, const O: u8> = crate::FieldWriter<'a, USART_RS485CR_SPEC, 8, O>;
impl R {
    #[doc = "Bit 0 - TXENP"]
    #[inline(always)]
