...
pub type USR0RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR0_SPEC, O>;
#[doc = "Field `USR1RST` reader - USR1RST"]
pub type USR1RST_R = crate::BitReader;
#[doc = "Field `USR1RST` writer - USR1RST"]
pub type USR1RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR0_SPEC, O>;
...
pub type SCI0RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR0_SPEC, O>;
...
pub type SCI1RST_W<'a, const O: u8> = crate::BitWriter<'a, RSTCU_APBPRSTR0_SPEC, O>;
impl R {
    #[doc = "Bit 0 - I2C0RST"]
    #[inline(always)]
