...
#[doc = "Field `PBLOCK15` reader - PBLOCK15"]
pub type PBLOCK15_R = crate::BitReader;
#[doc = "Field `PBLOCK15` writer - PBLOCK15"]
pub type PBLOCK15_W<'a, const O: u8> = crate::BitWriter<'a, PBLOCKR_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 15 - PBLOCK15"]
    #[inline(always)]
    pub fn pblock15(&self) -> PBLOCK15_R {
        PBLOCK15_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pblock15(&mut self) -> PBLOCK15_W<15> {
        PBLOCK15_W::new(self)
    }
    #[doc = "Bits 16:31 - PBLKEY"]
    #[inline(always)]
