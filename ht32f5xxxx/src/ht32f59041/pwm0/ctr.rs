...
#[doc = "Field `CHCDS` reader - CHCDS"]
pub type CHCDS_R = crate::BitReader;
#[doc = "Field `CHCDS` writer - CHCDS"]
pub type CHCDS_W<'a, const O: u8> = crate::BitWriter<'a, CTR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - TME"]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - CHCDS"]
    #[inline(always)]
    pub fn chcds(&self) -> CHCDS_R {
        CHCDS_R::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TME"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn chcds(&mut self) -> CHCDS_W<16> {
        CHCDS_W::new(self)
    }
