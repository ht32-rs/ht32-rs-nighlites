...
#[doc = "Field `PBSET15` reader - PBSET15"]
pub type PBSET15_R = crate::BitReader;
#[doc = "Field `PBSET15` writer - PBSET15"]
pub type PBSET15_W<'a, const O: u8> = crate::BitWriter<'a, PBSRR_SPEC, O>;
...
#[doc = "Field `PBRST15` reader - PBRST15"]
pub type PBRST15_R = crate::BitReader;
#[doc = "Field `PBRST15` writer - PBRST15"]
pub type PBRST15_W<'a, const O: u8> = crate::BitWriter<'a, PBSRR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBSET0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBSET15"]
    #[inline(always)]
    pub fn pbset15(&self) -> PBSET15_R {
        PBSET15_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - PBRST0"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - PBRST15"]
    #[inline(always)]
    pub fn pbrst15(&self) -> PBRST15_R {
        PBRST15_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBSET0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbset15(&mut self) -> PBSET15_W<15> {
        PBSET15_W::new(self)
    }
    #[doc = "Bit 16 - PBRST0"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbrst15(&mut self) -> PBRST15_W<31> {
        PBRST15_W::new(self)
    }
