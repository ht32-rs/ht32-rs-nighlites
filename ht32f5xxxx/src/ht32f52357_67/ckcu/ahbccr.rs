...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aesen(&mut self) -> AESEN_W<15> {
        AESEN_W::new(self)
    }
    #[doc = "Bit 16 - PAEN"]
    #[inline(always)]
