...
pub type I2C0EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
#[doc = "Field `I2C1EN` reader - I2C1EN"]
pub type I2C1EN_R = crate::BitReader;
#[doc = "Field `I2C1EN` writer - I2C1EN"]
pub type I2C1EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
...
pub type USR0EN_R = crate::BitReader;
#[doc = "Field `USR0EN` writer - USR0EN"]
pub type USR0EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
#[doc = "Field `USR1EN` reader - USR1EN"]
pub type USR1EN_R = crate::BitReader;
#[doc = "Field `USR1EN` writer - USR1EN"]
pub type USR1EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
...
#[doc = "Field `UR2EN` reader - UR2EN"]
pub type UR2EN_R = crate::BitReader;
#[doc = "Field `UR2EN` writer - UR2EN"]
pub type UR2EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
#[doc = "Field `UR3EN` reader - UR3EN"]
pub type UR3EN_R = crate::BitReader;
#[doc = "Field `UR3EN` writer - UR3EN"]
pub type UR3EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
...
pub type SCI0EN_R = crate::BitReader;
#[doc = "Field `SCI0EN` writer - SCI0EN"]
pub type SCI0EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
#[doc = "Field `I2SEN` reader - I2SEN"]
pub type I2SEN_R = crate::BitReader;
#[doc = "Field `I2SEN` writer - I2SEN"]
pub type I2SEN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
#[doc = "Field `SCI1EN` reader - SCI1EN"]
pub type SCI1EN_R = crate::BitReader;
#[doc = "Field `SCI1EN` writer - SCI1EN"]
pub type SCI1EN_W<'a, const O: u8> = crate::BitWriter<'a, APBCCR1_SPEC, O>;
impl R {
    #[doc = "Bit 0 - I2C0EN"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - UR2EN"]
    #[inline(always)]
    pub fn ur2en(&self) -> UR2EN_R {
        UR2EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - UR3EN"]
    #[inline(always)]
    pub fn ur3en(&self) -> UR3EN_R {
        UR3EN_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - AFIOEN"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ur2en(&mut self) -> UR2EN_W<12> {
        UR2EN_W::new(self)
    }
    #[doc = "Bit 13 - UR3EN"]
    #[inline(always)]
    #[must_use]
    pub fn ur3en(&mut self) -> UR3EN_W<13> {
        UR3EN_W::new(self)
    }
    #[doc = "Bit 14 - AFIOEN"]
    #[inline(always)]
