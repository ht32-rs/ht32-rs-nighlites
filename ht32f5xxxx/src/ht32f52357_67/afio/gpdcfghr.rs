...
pub struct R(crate::R<GPDCFGHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPDCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPDCFGHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPDCFGHR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPDCFGHR` writer"]
pub struct W(crate::W<GPDCFGHR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPDCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPDCFGHR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPDCFGHR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPDCFGHR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpdcfghr](index.html) module"]
pub struct GPDCFGHR_SPEC;
impl crate::RegisterSpec for GPDCFGHR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpdcfghr::R](R) reader structure"]
impl crate::Readable for GPDCFGHR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpdcfghr::W](W) writer structure"]
impl crate::Writable for GPDCFGHR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPDCFGHR to value 0"]
impl crate::Resettable for GPDCFGHR_SPEC {
