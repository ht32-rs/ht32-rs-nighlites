...
pub type CH0NP_W<'a, const O: u8> = crate::BitWriter<'a, CHPOLR_SPEC, O>;
...
pub type CH1NP_W<'a, const O: u8> = crate::BitWriter<'a, CHPOLR_SPEC, O>;
...
pub type CH2NP_W<'a, const O: u8> = crate::BitWriter<'a, CHPOLR_SPEC, O>;
