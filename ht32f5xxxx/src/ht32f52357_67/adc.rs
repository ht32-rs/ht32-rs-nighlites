...
#[doc = "ADCICLR"]
pub mod adciclr;
#[doc = "ADCDMAR (rw) register accessor: an alias for `Reg<ADCDMAR_SPEC>`"]
pub type ADCDMAR = crate::Reg<adcdmar::ADCDMAR_SPEC>;
#[doc = "ADCDMAR"]
pub mod adcdmar;
#[doc = "VREFCR (rw) register accessor: an alias for `Reg<VREFCR_SPEC>`"]
pub type VREFCR = crate::Reg<vrefcr::VREFCR_SPEC>;
#[doc = "VREFCR"]
pub mod vrefcr;
#[doc = "VREFVALR (rw) register accessor: an alias for `Reg<VREFVALR_SPEC>`"]
pub type VREFVALR = crate::Reg<vrefvalr::VREFVALR_SPEC>;
#[doc = "VREFVALR"]
pub mod vrefvalr;
