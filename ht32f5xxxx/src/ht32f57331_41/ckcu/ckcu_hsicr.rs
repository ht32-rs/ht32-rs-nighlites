...
pub type LTRSEL_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_HSICR_SPEC, O>;
#[doc = "Field `ATMSEL` reader - ATMSEL"]
pub type ATMSEL_R = crate::BitReader;
#[doc = "Field `ATMSEL` writer - ATMSEL"]
pub type ATMSEL_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_HSICR_SPEC, O>;
...
pub type REFCLKSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_HSICR_SPEC, 2, O>;
