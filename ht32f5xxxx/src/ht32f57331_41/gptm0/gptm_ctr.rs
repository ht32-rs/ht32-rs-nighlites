...
pub type TME_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CTR_SPEC, O>;
#[doc = "Field `CRBE` reader - CRBE"]
pub type CRBE_R = crate::BitReader;
#[doc = "Field `CRBE` writer - CRBE"]
pub type CRBE_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CTR_SPEC, O>;
#[doc = "Field `CHCCDS` reader - CHCCDS"]
pub type CHCCDS_R = crate::BitReader;
#[doc = "Field `CHCCDS` writer - CHCCDS"]
pub type CHCCDS_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CTR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - TME"]
    #[inline(always)]
