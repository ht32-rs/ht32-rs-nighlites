#[doc = "Register `USB_EP4ISR` reader"]
pub struct R(crate::R<USB_EP4ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB_EP4ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB_EP4ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB_EP4ISR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USB_EP4ISR` writer"]
pub struct W(crate::W<USB_EP4ISR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB_EP4ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB_EP4ISR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB_EP4ISR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "USB_EP4ISR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usb_ep4isr](index.html) module"]
pub struct USB_EP4ISR_SPEC;
impl crate::RegisterSpec for USB_EP4ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usb_ep4isr::R](R) reader structure"]
impl crate::Readable for USB_EP4ISR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usb_ep4isr::W](W) writer structure"]
impl crate::Writable for USB_EP4ISR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USB_EP4ISR to value 0"]
impl crate::Resettable for USB_EP4ISR_SPEC {
