#[doc = "Register `PWM_DICTR` reader"]
pub struct R(crate::R<PWM_DICTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_DICTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM_DICTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM_DICTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWM_DICTR` writer"]
pub struct W(crate::W<PWM_DICTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM_DICTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM_DICTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM_DICTR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PWM_DICTR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_dictr](index.html) module"]
pub struct PWM_DICTR_SPEC;
impl crate::RegisterSpec for PWM_DICTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_dictr::R](R) reader structure"]
impl crate::Readable for PWM_DICTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm_dictr::W](W) writer structure"]
impl crate::Writable for PWM_DICTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PWM_DICTR to value 0"]
impl crate::Resettable for PWM_DICTR_SPEC {
