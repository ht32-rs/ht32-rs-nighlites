...
pub type DBSCI0_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_MCUDBGCR_SPEC, O>;
...
pub type DBSCI1_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_MCUDBGCR_SPEC, O>;
...
pub type DBPWM0_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_MCUDBGCR_SPEC, O>;
#[doc = "Field `DBPWM1` reader - DBPWM1"]
pub type DBPWM1_R = crate::BitReader;
#[doc = "Field `DBPWM1` writer - DBPWM1"]
pub type DBPWM1_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_MCUDBGCR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - DBSLP"]
    #[inline(always)]
