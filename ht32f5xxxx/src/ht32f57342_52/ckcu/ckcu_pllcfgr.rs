...
pub type USBPOTD_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_PLLCFGR_SPEC, 2, O>;
#[doc = "Field `USBPFBD` reader - USBPFBD"]
pub type USBPFBD_R = crate::FieldReader;
#[doc = "Field `USBPFBD` writer - USBPFBD"]
pub type USBPFBD_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_PLLCFGR_SPEC, 4, O>;
...
pub type PFBD_W<'a, const O: u8> = crate::FieldWriter<'a, CKCU_PLLCFGR_SPEC, 4, O>;
#[doc = "Field `REFDIV` reader - REFDIV"]
pub type REFDIV_R = crate::BitReader;
#[doc = "Field `REFDIV` writer - REFDIV"]
pub type REFDIV_W<'a, const O: u8> = crate::BitWriter<'a, CKCU_PLLCFGR_SPEC, O>;
impl R {
    ...
    #[doc = "Bits 7:10 - USBPFBD"]
    #[inline(always)]
    pub fn usbpfbd(&self) -> USBPFBD_R {
        USBPFBD_R::new(((self.bits >> 7) & 0x0f) as u8)
    }
    #[doc = "Bits 21:22 - POTD"]
    #[inline(always)]
