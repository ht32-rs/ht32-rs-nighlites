...
pub struct RegisterBlock {
    ...
    _reserved8: [u8; 0x10],
    #[doc = "0x48 - GPFCFGLR"]
    pub gpfcfglr: GPFCFGLR,
    #[doc = "0x4c - GPFCFGHR"]
    pub gpfcfghr: GPFCFGHR,
}
...
#[doc = "GPCCFGHR"]
pub mod gpccfghr;
#[doc = "GPFCFGLR (rw) register accessor: an alias for `Reg<GPFCFGLR_SPEC>`"]
pub type GPFCFGLR = crate::Reg<gpfcfglr::GPFCFGLR_SPEC>;
#[doc = "GPFCFGLR"]
pub mod gpfcfglr;
#[doc = "GPFCFGHR (rw) register accessor: an alias for `Reg<GPFCFGHR_SPEC>`"]
pub type GPFCFGHR = crate::Reg<gpfcfghr::GPFCFGHR_SPEC>;
#[doc = "GPFCFGHR"]
pub mod gpfcfghr;
