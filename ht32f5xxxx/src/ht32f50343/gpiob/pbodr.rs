...
#[doc = "Field `PBOD15` reader - PBOD15"]
pub type PBOD15_R = crate::BitReader;
#[doc = "Field `PBOD15` writer - PBOD15"]
pub type PBOD15_W<'a, const O: u8> = crate::BitWriter<'a, PBODR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBOD0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBOD15"]
    #[inline(always)]
    pub fn pbod15(&self) -> PBOD15_R {
        PBOD15_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBOD0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbod15(&mut self) -> PBOD15_W<15> {
        PBOD15_W::new(self)
    }
