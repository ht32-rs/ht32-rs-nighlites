...
pub type SW_W<'a, const O: u8> = crate::FieldWriter<'a, GCCR_SPEC, 3, O>;
#[doc = "Field `USBPLLEN` reader - USBPLLEN"]
pub type USBPLLEN_R = crate::BitReader;
#[doc = "Field `USBPLLEN` writer - USBPLLEN"]
pub type USBPLLEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `HSEGAIN` reader - HSEGAIN"]
pub type HSEGAIN_R = crate::BitReader;
#[doc = "Field `HSEGAIN` writer - HSEGAIN"]
pub type HSEGAIN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `PLLEN` reader - PLLEN"]
pub type PLLEN_R = crate::BitReader;
#[doc = "Field `PLLEN` writer - PLLEN"]
pub type PLLEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `HSEEN` reader - HSEEN"]
pub type HSEEN_R = crate::BitReader;
#[doc = "Field `HSEEN` writer - HSEEN"]
pub type HSEEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `HSIEN` reader - HSIEN"]
pub type HSIEN_R = crate::BitReader;
#[doc = "Field `HSIEN` writer - HSIEN"]
pub type HSIEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `CKMEN` reader - CKMEN"]
pub type CKMEN_R = crate::BitReader;
#[doc = "Field `CKMEN` writer - CKMEN"]
pub type CKMEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
#[doc = "Field `PSRCEN` reader - PSRCEN"]
pub type PSRCEN_R = crate::BitReader;
#[doc = "Field `PSRCEN` writer - PSRCEN"]
pub type PSRCEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCR_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - SW"]
    #[inline(always)]
    pub fn sw(&self) -> SW_R {
    ...
    #[doc = "Bit 3 - USBPLLEN"]
    #[inline(always)]
    pub fn usbpllen(&self) -> USBPLLEN_R {
        USBPLLEN_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 8 - HSEGAIN"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbpllen(&mut self) -> USBPLLEN_W<3> {
        USBPLLEN_W::new(self)
    }
    #[doc = "Bit 8 - HSEGAIN"]
    #[inline(always)]
