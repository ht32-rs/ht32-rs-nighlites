#[doc = "Register `URCR` reader"]
pub struct R(crate::R<URCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<URCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<URCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<URCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `URCR` writer"]
pub struct W(crate::W<URCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<URCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<URCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<URCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "URCR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [urcr](index.html) module"]
pub struct URCR_SPEC;
impl crate::RegisterSpec for URCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [urcr::R](R) reader structure"]
impl crate::Readable for URCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [urcr::W](W) writer structure"]
impl crate::Writable for URCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets URCR to value 0"]
impl crate::Resettable for URCR_SPEC {
