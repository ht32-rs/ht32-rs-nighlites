...
#[doc = "Field `CH4CIE` reader - CH4CIE"]
pub type CH4CIE_R = crate::BitReader;
#[doc = "Field `CH4CIE` writer - CH4CIE"]
pub type CH4CIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH5CIE` reader - CH5CIE"]
pub type CH5CIE_R = crate::BitReader;
#[doc = "Field `CH5CIE` writer - CH5CIE"]
pub type CH5CIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH6CIE` reader - CH6CIE"]
pub type CH6CIE_R = crate::BitReader;
#[doc = "Field `CH6CIE` writer - CH6CIE"]
pub type CH6CIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH7CIE` reader - CH7CIE"]
pub type CH7CIE_R = crate::BitReader;
#[doc = "Field `CH7CIE` writer - CH7CIE"]
pub type CH7CIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CH0CIE"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - CH4CIE"]
    #[inline(always)]
    pub fn ch4cie(&self) -> CH4CIE_R {
        CH4CIE_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - CH5CIE"]
    #[inline(always)]
    pub fn ch5cie(&self) -> CH5CIE_R {
        CH5CIE_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - CH6CIE"]
    #[inline(always)]
    pub fn ch6cie(&self) -> CH6CIE_R {
        CH6CIE_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - CH7CIE"]
    #[inline(always)]
    pub fn ch7cie(&self) -> CH7CIE_R {
        CH7CIE_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - CH0CIE"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4cie(&mut self) -> CH4CIE_W<28> {
        CH4CIE_W::new(self)
    }
    #[doc = "Bit 29 - CH5CIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch5cie(&mut self) -> CH5CIE_W<29> {
        CH5CIE_W::new(self)
    }
    #[doc = "Bit 30 - CH6CIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch6cie(&mut self) -> CH6CIE_W<30> {
        CH6CIE_W::new(self)
    }
    #[doc = "Bit 31 - CH7CIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch7cie(&mut self) -> CH7CIE_W<31> {
        CH7CIE_W::new(self)
    }
