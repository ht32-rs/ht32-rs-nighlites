...
#[doc = "Field `CH4CG` reader - CH4CG"]
pub type CH4CG_R = crate::BitReader;
#[doc = "Field `CH4CG` writer - CH4CG"]
pub type CH4CG_W<'a, const O: u8> = crate::BitWriter<'a, EVGR_SPEC, O>;
#[doc = "Field `CH5CG` reader - CH5CG"]
pub type CH5CG_R = crate::BitReader;
#[doc = "Field `CH5CG` writer - CH5CG"]
pub type CH5CG_W<'a, const O: u8> = crate::BitWriter<'a, EVGR_SPEC, O>;
#[doc = "Field `CH6CG` reader - CH6CG"]
pub type CH6CG_R = crate::BitReader;
#[doc = "Field `CH6CG` writer - CH6CG"]
pub type CH6CG_W<'a, const O: u8> = crate::BitWriter<'a, EVGR_SPEC, O>;
#[doc = "Field `CH7CG` reader - CH7CG"]
pub type CH7CG_R = crate::BitReader;
#[doc = "Field `CH7CG` writer - CH7CG"]
pub type CH7CG_W<'a, const O: u8> = crate::BitWriter<'a, EVGR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CH0CG"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - CH4CG"]
    #[inline(always)]
    pub fn ch4cg(&self) -> CH4CG_R {
        CH4CG_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - CH5CG"]
    #[inline(always)]
    pub fn ch5cg(&self) -> CH5CG_R {
        CH5CG_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - CH6CG"]
    #[inline(always)]
    pub fn ch6cg(&self) -> CH6CG_R {
        CH6CG_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - CH7CG"]
    #[inline(always)]
    pub fn ch7cg(&self) -> CH7CG_R {
        CH7CG_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - CH0CG"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4cg(&mut self) -> CH4CG_W<28> {
        CH4CG_W::new(self)
    }
    #[doc = "Bit 29 - CH5CG"]
    #[inline(always)]
    #[must_use]
    pub fn ch5cg(&mut self) -> CH5CG_W<29> {
        CH5CG_W::new(self)
    }
    #[doc = "Bit 30 - CH6CG"]
    #[inline(always)]
    #[must_use]
    pub fn ch6cg(&mut self) -> CH6CG_W<30> {
        CH6CG_W::new(self)
    }
    #[doc = "Bit 31 - CH7CG"]
    #[inline(always)]
    #[must_use]
    pub fn ch7cg(&mut self) -> CH7CG_W<31> {
        CH7CG_W::new(self)
    }
