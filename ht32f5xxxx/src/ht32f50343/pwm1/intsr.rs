...
#[doc = "Field `CH4CIF` reader - CH4CIF"]
pub type CH4CIF_R = crate::BitReader;
#[doc = "Field `CH4CIF` writer - CH4CIF"]
pub type CH4CIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `CH5CIF` reader - CH5CIF"]
pub type CH5CIF_R = crate::BitReader;
#[doc = "Field `CH5CIF` writer - CH5CIF"]
pub type CH5CIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `CH6CIF` reader - CH6CIF"]
pub type CH6CIF_R = crate::BitReader;
#[doc = "Field `CH6CIF` writer - CH6CIF"]
pub type CH6CIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `CH7CIF` reader - CH7CIF"]
pub type CH7CIF_R = crate::BitReader;
#[doc = "Field `CH7CIF` writer - CH7CIF"]
pub type CH7CIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CH0CIF"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - CH4CIF"]
    #[inline(always)]
    pub fn ch4cif(&self) -> CH4CIF_R {
        CH4CIF_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - CH5CIF"]
    #[inline(always)]
    pub fn ch5cif(&self) -> CH5CIF_R {
        CH5CIF_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - CH6CIF"]
    #[inline(always)]
    pub fn ch6cif(&self) -> CH6CIF_R {
        CH6CIF_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - CH7CIF"]
    #[inline(always)]
    pub fn ch7cif(&self) -> CH7CIF_R {
        CH7CIF_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - CH0CIF"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4cif(&mut self) -> CH4CIF_W<28> {
        CH4CIF_W::new(self)
    }
    #[doc = "Bit 29 - CH5CIF"]
    #[inline(always)]
    #[must_use]
    pub fn ch5cif(&mut self) -> CH5CIF_W<29> {
        CH5CIF_W::new(self)
    }
    #[doc = "Bit 30 - CH6CIF"]
    #[inline(always)]
    #[must_use]
    pub fn ch6cif(&mut self) -> CH6CIF_W<30> {
        CH6CIF_W::new(self)
    }
    #[doc = "Bit 31 - CH7CIF"]
    #[inline(always)]
    #[must_use]
    pub fn ch7cif(&mut self) -> CH7CIF_W<31> {
        CH7CIF_W::new(self)
    }
