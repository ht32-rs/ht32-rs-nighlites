#[doc = "Register `GPBCFGHR` reader"]
pub struct R(crate::R<GPBCFGHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPBCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPBCFGHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPBCFGHR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPBCFGHR` writer"]
pub struct W(crate::W<GPBCFGHR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPBCFGHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPBCFGHR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPBCFGHR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPBCFGHR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpbcfghr](index.html) module"]
pub struct GPBCFGHR_SPEC;
impl crate::RegisterSpec for GPBCFGHR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpbcfghr::R](R) reader structure"]
impl crate::Readable for GPBCFGHR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpbcfghr::W](W) writer structure"]
impl crate::Writable for GPBCFGHR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPBCFGHR to value 0"]
impl crate::Resettable for GPBCFGHR_SPEC {
