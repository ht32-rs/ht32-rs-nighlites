...
pub type PWRST_W<'a, const O: u8> = crate::BitWriter<'a, PWRCR_SPEC, O>;
...
pub type WUPIEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCR_SPEC, O>;
#[doc = "Field `V15RDYSC` reader - V15RDYSC"]
pub type V15RDYSC_R = crate::BitReader;
#[doc = "Field `V15RDYSC` writer - V15RDYSC"]
pub type V15RDYSC_W<'a, const O: u8> = crate::BitWriter<'a, PWRCR_SPEC, O>;
