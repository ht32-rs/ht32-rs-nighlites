...
pub type SPIRST_W<'a, const O: u8> = crate::BitWriter<'a, APBPRSTR0_SPEC, O>;
#[doc = "Field `USRRST` reader - USRRST"]
pub type USRRST_R = crate::BitReader;
#[doc = "Field `USRRST` writer - USRRST"]
pub type USRRST_W<'a, const O: u8> = crate::BitWriter<'a, APBPRSTR0_SPEC, O>;
#[doc = "Field `URRST` reader - URRST"]
pub type URRST_R = crate::BitReader;
#[doc = "Field `URRST` writer - URRST"]
pub type URRST_W<'a, const O: u8> = crate::BitWriter<'a, APBPRSTR0_SPEC, O>;
