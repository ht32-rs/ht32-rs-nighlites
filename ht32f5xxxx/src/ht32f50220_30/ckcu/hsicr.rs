...
pub type TRIMEN_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `ATCEN` reader - ATCEN"]
pub type ATCEN_R = crate::BitReader;
#[doc = "Field `ATCEN` writer - ATCEN"]
pub type ATCEN_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `LTRSEL` reader - LTRSEL"]
pub type LTRSEL_R = crate::BitReader;
#[doc = "Field `LTRSEL` writer - LTRSEL"]
pub type LTRSEL_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `ATMSEL` reader - ATMSEL"]
pub type ATMSEL_R = crate::BitReader;
#[doc = "Field `ATMSEL` writer - ATMSEL"]
pub type ATMSEL_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `TMSEL` reader - TMSEL"]
pub type TMSEL_R = crate::BitReader;
#[doc = "Field `TMSEL` writer - TMSEL"]
pub type TMSEL_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `REFCLKSEL` reader - REFCLKSEL"]
pub type REFCLKSEL_R = crate::FieldReader;
#[doc = "Field `REFCLKSEL` writer - REFCLKSEL"]
pub type REFCLKSEL_W<'a, const O: u8> = crate::FieldWriter<'a, HSICR_SPEC, 2, O>;
#[doc = "Field `FLOCK` reader - FLOCK"]
pub type FLOCK_R = crate::BitReader;
#[doc = "Field `FLOCK` writer - FLOCK"]
pub type FLOCK_W<'a, const O: u8> = crate::BitWriter<'a, HSICR_SPEC, O>;
#[doc = "Field `HSIFINE` reader - HSIFINE"]
pub type HSIFINE_R = crate::FieldReader;
#[doc = "Field `HSIFINE` writer - HSIFINE"]
pub type HSIFINE_W<'a, const O: u8> = crate::FieldWriter<'a, HSICR_SPEC, 8, O>;
#[doc = "Field `HSICOARSE` reader - HSICOARSE"]
pub type HSICOARSE_R = crate::FieldReader;
#[doc = "Field `HSICOARSE` writer - HSICOARSE"]
pub type HSICOARSE_W<'a, const O: u8> = crate::FieldWriter<'a, HSICR_SPEC, 5, O>;
impl R {
    #[doc = "Bit 0 - TRIMEN"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - LTRSEL"]
    #[inline(always)]
    pub fn ltrsel(&self) -> LTRSEL_R {
        LTRSEL_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - ATMSEL"]
    #[inline(always)]
    pub fn atmsel(&self) -> ATMSEL_R {
        ATMSEL_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - TMSEL"]
    #[inline(always)]
    ...
    #[doc = "Bits 5:6 - REFCLKSEL"]
    #[inline(always)]
    pub fn refclksel(&self) -> REFCLKSEL_R {
        REFCLKSEL_R::new(((self.bits >> 5) & 3) as u8)
    }
    #[doc = "Bit 7 - FLOCK"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ltrsel(&mut self) -> LTRSEL_W<2> {
        LTRSEL_W::new(self)
    }
    #[doc = "Bit 3 - ATMSEL"]
    #[inline(always)]
    #[must_use]
    pub fn atmsel(&mut self) -> ATMSEL_W<3> {
        ATMSEL_W::new(self)
    }
    #[doc = "Bit 4 - TMSEL"]
    #[inline(always)]
