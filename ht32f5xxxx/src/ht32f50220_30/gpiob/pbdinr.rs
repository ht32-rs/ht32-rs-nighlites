...
#[doc = "Field `PBDIN15` reader - PBDIN15"]
pub type PBDIN15_R = crate::BitReader;
#[doc = "Field `PBDIN15` writer - PBDIN15"]
pub type PBDIN15_W<'a, const O: u8> = crate::BitWriter<'a, PBDINR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBDIN0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBDIN15"]
    #[inline(always)]
    pub fn pbdin15(&self) -> PBDIN15_R {
        PBDIN15_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBDIN0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbdin15(&mut self) -> PBDIN15_W<15> {
        PBDIN15_W::new(self)
    }
