...
#[doc = "Field `PBPD15` reader - PBPD15"]
pub type PBPD15_R = crate::BitReader;
#[doc = "Field `PBPD15` writer - PBPD15"]
pub type PBPD15_W<'a, const O: u8> = crate::BitWriter<'a, PBPDR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBPD0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBPD15"]
    #[inline(always)]
    pub fn pbpd15(&self) -> PBPD15_R {
        PBPD15_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBPD0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbpd15(&mut self) -> PBPD15_W<15> {
        PBPD15_W::new(self)
    }
