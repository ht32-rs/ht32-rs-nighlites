...
#[doc = "Field `WUP0IEN` reader - WUP0IEN"]
pub type WUP0IEN_R = crate::BitReader;
#[doc = "Field `WUP0IEN` writer - WUP0IEN"]
pub type WUP0IEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCR_SPEC, O>;
...
#[doc = "Field `WUP1IEN` reader - WUP1IEN"]
pub type WUP1IEN_R = crate::BitReader;
#[doc = "Field `WUP1IEN` writer - WUP1IEN"]
pub type WUP1IEN_W<'a, const O: u8> = crate::BitWriter<'a, PWRCR_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 9 - WUP0IEN"]
    #[inline(always)]
    pub fn wup0ien(&self) -> WUP0IEN_R {
        WUP0IEN_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - WUP1EN"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - WUP1IEN"]
    #[inline(always)]
    pub fn wup1ien(&self) -> WUP1IEN_R {
        WUP1IEN_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 15 - DMOSSTS"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wup0ien(&mut self) -> WUP0IEN_W<9> {
        WUP0IEN_W::new(self)
    }
    #[doc = "Bit 10 - WUP1EN"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wup1ien(&mut self) -> WUP1IEN_W<11> {
        WUP1IEN_W::new(self)
    }
    #[doc = "Bit 15 - DMOSSTS"]
    #[inline(always)]
