...
#[doc = "Field `MCTMCSEL` reader - MCTMCSEL"]
pub type MCTMCSEL_R = crate::BitReader;
#[doc = "Field `MCTMCSEL` writer - MCTMCSEL"]
pub type MCTMCSEL_W<'a, const O: u8> = crate::BitWriter<'a, APBCFGR_SPEC, O>;
#[doc = "Field `ADCDIV` reader - ADCDIV"]
pub type ADCDIV_R = crate::FieldReader;
#[doc = "Field `ADCDIV` writer - ADCDIV"]
pub type ADCDIV_W<'a, const O: u8> = crate::FieldWriter<'a, APBCFGR_SPEC, 3, O>;
impl R {
    #[doc = "Bit 8 - MCTMCSEL"]
    #[inline(always)]
    pub fn mctmcsel(&self) -> MCTMCSEL_R {
        MCTMCSEL_R::new(((self.bits >> 8) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mctmcsel(&mut self) -> MCTMCSEL_W<8> {
        MCTMCSEL_W::new(self)
    }
    #[doc = "Bits 16:18 - ADCDIV"]
    #[inline(always)]
