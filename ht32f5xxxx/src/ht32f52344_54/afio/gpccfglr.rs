#[doc = "Register `GPCCFGLR` reader"]
pub struct R(crate::R<GPCCFGLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPCCFGLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPCCFGLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPCCFGLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPCCFGLR` writer"]
pub struct W(crate::W<GPCCFGLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPCCFGLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPCCFGLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPCCFGLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPCCFGLR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpccfglr](index.html) module"]
pub struct GPCCFGLR_SPEC;
impl crate::RegisterSpec for GPCCFGLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpccfglr::R](R) reader structure"]
impl crate::Readable for GPCCFGLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpccfglr::W](W) writer structure"]
impl crate::Writable for GPCCFGLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPCCFGLR to value 0"]
impl crate::Resettable for GPCCFGLR_SPEC {
