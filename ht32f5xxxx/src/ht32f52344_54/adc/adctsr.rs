...
pub type TMS_R = crate::FieldReader;
#[doc = "Field `TMS` writer - TMS"]
pub type TMS_W<'a, const O: u8> = crate::FieldWriter<'a, ADCTSR_SPEC, 3, O>;
#[doc = "Field `BFTMS` reader - BFTMS"]
pub type BFTMS_R = crate::BitReader;
#[doc = "Field `BFTMS` writer - BFTMS"]
pub type BFTMS_W<'a, const O: u8> = crate::BitWriter<'a, ADCTSR_SPEC, O>;
#[doc = "Field `CMPS` reader - CMPS"]
pub type CMPS_R = crate::BitReader;
#[doc = "Field `CMPS` writer - CMPS"]
pub type CMPS_W<'a, const O: u8> = crate::BitWriter<'a, ADCTSR_SPEC, O>;
#[doc = "Field `TME` reader - TME"]
pub type TME_R = crate::FieldReader;
#[doc = "Field `TME` writer - TME"]
pub type TME_W<'a, const O: u8> = crate::FieldWriter<'a, ADCTSR_SPEC, 3, O>;
impl R {
    #[doc = "Bit 0 - ADSC"]
    #[inline(always)]
