...
#[doc = "Field `PBINEN15` reader - PBINEN15"]
pub type PBINEN15_R = crate::BitReader;
#[doc = "Field `PBINEN15` writer - PBINEN15"]
pub type PBINEN15_W<'a, const O: u8> = crate::BitWriter<'a, PBINER_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBINEN0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBINEN15"]
    #[inline(always)]
    pub fn pbinen15(&self) -> PBINEN15_R {
        PBINEN15_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBINEN0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbinen15(&mut self) -> PBINEN15_W<15> {
        PBINEN15_W::new(self)
    }
