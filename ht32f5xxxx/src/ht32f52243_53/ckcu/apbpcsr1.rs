...
pub type UR2PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, APBPCSR1_SPEC, 2, O>;
#[doc = "Field `UR3PCLK` reader - UR3PCLK"]
pub type UR3PCLK_R = crate::FieldReader;
#[doc = "Field `UR3PCLK` writer - UR3PCLK"]
pub type UR3PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, APBPCSR1_SPEC, 2, O>;
...
pub type USR0PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, APBPCSR1_SPEC, 2, O>;
#[doc = "Field `USR1PCLK` reader - USR1PCLK"]
pub type USR1PCLK_R = crate::FieldReader;
#[doc = "Field `USR1PCLK` writer - USR1PCLK"]
pub type USR1PCLK_W<'a, const O: u8> = crate::FieldWriter<'a, APBPCSR1_SPEC, 2, O>;
