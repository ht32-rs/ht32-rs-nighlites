...
#[doc = "Field `DBI2C2` reader - DBI2C2"]
pub type DBI2C2_R = crate::BitReader;
#[doc = "Field `DBI2C2` writer - DBI2C2"]
pub type DBI2C2_W<'a, const O: u8> = crate::BitWriter<'a, MCUDBGCR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - DBSLP"]
    #[inline(always)]
    ...
    #[doc = "Bit 28 - DBI2C2"]
    #[inline(always)]
    pub fn dbi2c2(&self) -> DBI2C2_R {
        DBI2C2_R::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DBSLP"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbi2c2(&mut self) -> DBI2C2_W<28> {
        DBI2C2_W::new(self)
    }
