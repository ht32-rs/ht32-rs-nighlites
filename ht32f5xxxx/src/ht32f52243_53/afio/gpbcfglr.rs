#[doc = "Register `GPBCFGLR` reader"]
pub struct R(crate::R<GPBCFGLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPBCFGLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPBCFGLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPBCFGLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPBCFGLR` writer"]
pub struct W(crate::W<GPBCFGLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPBCFGLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPBCFGLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPBCFGLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPBCFGLR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpbcfglr](index.html) module"]
pub struct GPBCFGLR_SPEC;
impl crate::RegisterSpec for GPBCFGLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpbcfglr::R](R) reader structure"]
impl crate::Readable for GPBCFGLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpbcfglr::W](W) writer structure"]
impl crate::Writable for GPBCFGLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPBCFGLR to value 0"]
impl crate::Resettable for GPBCFGLR_SPEC {
