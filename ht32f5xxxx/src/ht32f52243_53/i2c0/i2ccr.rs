...
#[doc = "Field `COMBFILTERE` reader - COMBFILTERE"]
pub type COMBFILTERE_R = crate::BitReader;
#[doc = "Field `COMBFILTERE` writer - COMBFILTERE"]
pub type COMBFILTERE_W<'a, const O: u8> = crate::BitWriter<'a, I2CCR_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 13 - COMBFILTERE"]
    #[inline(always)]
    pub fn combfiltere(&self) -> COMBFILTERE_R {
        COMBFILTERE_R::new(((self.bits >> 13) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn combfiltere(&mut self) -> COMBFILTERE_W<13> {
        COMBFILTERE_W::new(self)
    }
    #[doc = "Bits 14:15 - SEQFILTER"]
    #[inline(always)]
    #[must_use]
