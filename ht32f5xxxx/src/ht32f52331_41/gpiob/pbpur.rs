...
#[doc = "Field `PBPU15` reader - PBPU15"]
pub type PBPU15_R = crate::BitReader;
#[doc = "Field `PBPU15` writer - PBPU15"]
pub type PBPU15_W<'a, const O: u8> = crate::BitWriter<'a, PBPUR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - PBPU0"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - PBPU15"]
    #[inline(always)]
    pub fn pbpu15(&self) -> PBPU15_R {
        PBPU15_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PBPU0"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pbpu15(&mut self) -> PBPU15_W<15> {
        PBPU15_W::new(self)
    }
