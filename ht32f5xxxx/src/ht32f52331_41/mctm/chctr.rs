...
pub type CH0NE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTR_SPEC, O>;
...
pub type CH1NE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTR_SPEC, O>;
...
pub type CH2NE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTR_SPEC, O>;
