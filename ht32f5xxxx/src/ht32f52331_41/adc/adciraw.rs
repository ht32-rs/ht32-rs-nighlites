#[doc = "Register `ADCIRAW` reader"]
pub struct R(crate::R<ADCIRAW_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADCIRAW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADCIRAW_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADCIRAW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADCIRAW` writer"]
pub struct W(crate::W<ADCIRAW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADCIRAW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADCIRAW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADCIRAW_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "ADCIRAW\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [adciraw](index.html) module"]
pub struct ADCIRAW_SPEC;
impl crate::RegisterSpec for ADCIRAW_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [adciraw::R](R) reader structure"]
impl crate::Readable for ADCIRAW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [adciraw::W](W) writer structure"]
impl crate::Writable for ADCIRAW_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ADCIRAW to value 0"]
impl crate::Resettable for ADCIRAW_SPEC {
