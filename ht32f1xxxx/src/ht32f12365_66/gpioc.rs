...
#[doc = "GPIOC_ODR"]
pub mod gpioc_odr;
#[doc = "GPIOC_DRVR\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioc_drvr](gpioc_drvr) module"]
pub type GPIOC_DRVR = crate::Reg<u32, _GPIOC_DRVR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _GPIOC_DRVR;
#[doc = "`read()` method returns [gpioc_drvr::R](gpioc_drvr::R) reader structure"]
impl crate::Readable for GPIOC_DRVR {}
#[doc = "`write(|w| ..)` method takes [gpioc_drvr::W](gpioc_drvr::W) writer structure"]
impl crate::Writable for GPIOC_DRVR {}
#[doc = "GPIOC_DRVR"]
pub mod gpioc_drvr;
