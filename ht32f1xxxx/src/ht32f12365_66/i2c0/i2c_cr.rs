...
pub type COMB_FILTER_EN_R = crate::BitReader;
#[doc = "Field `COMB_FILTER_EN` writer - COMB_FILTER_EN"]
pub type COMB_FILTER_EN_W<'a, const O: u8> = crate::BitWriter<'a, I2C_CR_SPEC, O>;
#[doc = "Field `SEQ_FILTER` reader - SEQ_FILTER"]
pub type SEQ_FILTER_R = crate::FieldReader;
#[doc = "Field `SEQ_FILTER` writer - SEQ_FILTER"]
pub type SEQ_FILTER_W<'a, const O: u8> = crate::FieldWriter<'a, I2C_CR_SPEC, 2, O>;
impl R {
    #[doc = "Bit 0 - AA"]
    #[inline(always)]
    pub fn aa(&self) -> AA_R {
