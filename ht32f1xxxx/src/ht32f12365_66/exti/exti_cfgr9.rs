#[doc = "Reader of register EXTI_CFGR9"]
pub type R = crate::R<u32, super::EXTI_CFGR9>;
#[doc = "Writer for register EXTI_CFGR9"]
pub type W = crate::W<u32, super::EXTI_CFGR9>;
#[doc = "Register EXTI_CFGR9 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR9 {
    type Type = u32;
    #[inline(always)]
