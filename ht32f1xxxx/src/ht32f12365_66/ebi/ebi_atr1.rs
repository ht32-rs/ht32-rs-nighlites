#[doc = "Reader of register EBI_ATR1"]
pub type R = crate::R<u32, super::EBI_ATR1>;
#[doc = "Writer for register EBI_ATR1"]
pub type W = crate::W<u32, super::EBI_ATR1>;
#[doc = "Register EBI_ATR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_ATR1 {
    type Type = u32;
    #[inline(always)]
