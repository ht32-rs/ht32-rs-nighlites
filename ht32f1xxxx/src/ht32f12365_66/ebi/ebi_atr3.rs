#[doc = "Reader of register EBI_ATR3"]
pub type R = crate::R<u32, super::EBI_ATR3>;
#[doc = "Writer for register EBI_ATR3"]
pub type W = crate::W<u32, super::EBI_ATR3>;
#[doc = "Register EBI_ATR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_ATR3 {
    type Type = u32;
    #[inline(always)]
