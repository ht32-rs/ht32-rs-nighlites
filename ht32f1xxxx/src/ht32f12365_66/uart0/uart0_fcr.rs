...
#[doc = "`read()` method returns [uart0_fcr::R](R) reader structure"]
impl crate::Readable for UART0_FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart0_fcr::W](W) writer structure"]
impl crate::Writable for UART0_FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART0_FCR to value 0"]
