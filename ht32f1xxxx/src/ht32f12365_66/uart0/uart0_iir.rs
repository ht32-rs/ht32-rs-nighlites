...
#[doc = "Register `UART0_IIR` writer"]
pub struct W(crate::W<UART0_IIR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART0_IIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART0_IIR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART0_IIR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NIP_W<'a, const O: u8> = crate::BitWriter<'a, UART0_IIR_SPEC, O>;
#[doc = "Field `IID` reader - IID"]
pub type IID_R = crate::FieldReader;
#[doc = "Field `IID` writer - IID"]
pub type IID_W<'a, const O: u8> = crate::FieldWriter<'a, UART0_IIR_SPEC, 3, O>;
impl R {
    #[doc = "Bit 0 - NIP"]
    #[inline(always)]
...
#[doc = "`read()` method returns [uart0_iir::R](R) reader structure"]
impl crate::Readable for UART0_IIR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart0_iir::W](W) writer structure"]
impl crate::Writable for UART0_IIR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UART0_IIR to value 0"]
