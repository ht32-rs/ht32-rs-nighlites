#[doc = "Reader of register PDMA_CH7TSR"]
pub type R = crate::R<u32, super::PDMA_CH7TSR>;
#[doc = "Writer for register PDMA_CH7TSR"]
pub type W = crate::W<u32, super::PDMA_CH7TSR>;
#[doc = "Register PDMA_CH7TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH7TSR {
    type Type = u32;
    #[inline(always)]
