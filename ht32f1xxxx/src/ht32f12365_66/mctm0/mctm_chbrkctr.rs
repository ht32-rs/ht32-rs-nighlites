#[doc = "Reader of register MCTM_CHBRKCTR"]
pub type R = crate::R<u32, super::MCTM_CHBRKCTR>;
#[doc = "Writer for register MCTM_CHBRKCTR"]
pub type W = crate::W<u32, super::MCTM_CHBRKCTR>;
#[doc = "Register MCTM_CHBRKCTR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCTM_CHBRKCTR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `BKE1`"]
pub type BKE1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `BKE1`"]
pub struct BKE1_W<'a> {
    w: &'a mut W,
}
impl<'a> BKE1_W<'a> {
...
#[doc = "Reader of field `BKP1`"]
pub type BKP1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `BKP1`"]
pub struct BKP1_W<'a> {
    w: &'a mut W,
}
impl<'a> BKP1_W<'a> {
...
#[doc = "Reader of field `BK1SEL`"]
pub type BK1SEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `BK1SEL`"]
pub struct BK1SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> BK1SEL_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `BKF1`"]
pub type BKF1_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `BKF1`"]
pub struct BKF1_W<'a> {
    w: &'a mut W,
}
impl<'a> BKF1_W<'a> {
...
#[doc = "Reader of field `GFSEL1`"]
pub type GFSEL1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GFSEL1`"]
pub struct GFSEL1_W<'a> {
    w: &'a mut W,
}
impl<'a> GFSEL1_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn bke1(&self) -> BKE1_R {
        BKE1_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - BKP1"]
    #[inline(always)]
    pub fn bkp1(&self) -> BKP1_R {
        BKP1_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - CHMOE"]
    #[inline(always)]
    ...
    pub fn bk1sel(&self) -> BK1SEL_R {
        BK1SEL_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bits 8:11 - BKF0"]
    #[inline(always)]
    ...
    pub fn gfsel1(&self) -> GFSEL1_R {
        GFSEL1_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bit 20 - CHOSSI"]
    #[inline(always)]
