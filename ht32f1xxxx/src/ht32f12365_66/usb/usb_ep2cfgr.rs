#[doc = "Reader of register USB_EP2CFGR"]
pub type R = crate::R<u32, super::USB_EP2CFGR>;
#[doc = "Writer for register USB_EP2CFGR"]
pub type W = crate::W<u32, super::USB_EP2CFGR>;
#[doc = "Register USB_EP2CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_EP2CFGR {
    type Type = u32;
    #[inline(always)]
...
pub type EPLEN_R = crate::R<u8, u8>;
