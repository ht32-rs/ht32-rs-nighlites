...
#[doc = "Field `ADAL6` reader - ADAL6"]
pub type ADAL6_R = crate::BitReader;
#[doc = "Field `ADAL6` writer - ADAL6"]
pub type ADAL6_W<'a, const O: u8> = crate::BitWriter<'a, ADC_OFR6_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adal6(&mut self) -> ADAL6_W<14> {
        ADAL6_W::new(self)
    }
    #[doc = "Bit 15 - ADOFE6"]
    #[inline(always)]
