...
#[doc = "Field `ADAL1` reader - ADAL1"]
pub type ADAL1_R = crate::BitReader;
#[doc = "Field `ADAL1` writer - ADAL1"]
pub type ADAL1_W<'a, const O: u8> = crate::BitWriter<'a, ADC_OFR1_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 14 - ADAL1"]
    #[inline(always)]
    pub fn adal1(&self) -> ADAL1_R {
        ADAL1_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - ADOFE1"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adal1(&mut self) -> ADAL1_W<14> {
        ADAL1_W::new(self)
    }
    #[doc = "Bit 15 - ADOFE1"]
    #[inline(always)]
