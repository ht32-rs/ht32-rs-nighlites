#[doc = "Reader of register MCTM_CH1ICFR"]
pub type R = crate::R<u32, super::MCTM_CH1ICFR>;
#[doc = "Writer for register MCTM_CH1ICFR"]
pub type W = crate::W<u32, super::MCTM_CH1ICFR>;
#[doc = "Register MCTM_CH1ICFR `reset()`'s with value 0"]
impl crate::ResetValue for super::MCTM_CH1ICFR {
    type Type = u32;
    #[inline(always)]
