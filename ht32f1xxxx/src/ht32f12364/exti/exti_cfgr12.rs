#[doc = "Reader of register EXTI_CFGR12"]
pub type R = crate::R<u32, super::EXTI_CFGR12>;
#[doc = "Writer for register EXTI_CFGR12"]
pub type W = crate::W<u32, super::EXTI_CFGR12>;
#[doc = "Register EXTI_CFGR12 `reset()`'s with value 0"]
impl crate::ResetValue for super::EXTI_CFGR12 {
    type Type = u32;
    #[inline(always)]
