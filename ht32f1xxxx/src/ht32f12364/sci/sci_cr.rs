...
#[doc = "Field `RETRY4_5` reader - RETRY4_5"]
pub type RETRY4_5_R = crate::BitReader;
#[doc = "Field `RETRY4_5` writer - RETRY4_5"]
pub type RETRY4_5_W<'a, const O: u8> = crate::BitWriter<'a, SCI_CR_SPEC, O>;
...
impl R {
    ...
    pub fn retry4_5(&self) -> RETRY4_5_R {
        RETRY4_5_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - ENSCI"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn retry4_5(&mut self) -> RETRY4_5_W<4> {
        RETRY4_5_W::new(self)
    }
    #[doc = "Bit 5 - ENSCI"]
    #[inline(always)]
