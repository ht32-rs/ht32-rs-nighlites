#[doc = "Reader of register EBI_WTR0"]
pub type R = crate::R<u32, super::EBI_WTR0>;
#[doc = "Writer for register EBI_WTR0"]
pub type W = crate::W<u32, super::EBI_WTR0>;
#[doc = "Register EBI_WTR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_WTR0 {
    type Type = u32;
    #[inline(always)]
