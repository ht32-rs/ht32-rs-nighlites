#[doc = "Reader of register EBI_WTR2"]
pub type R = crate::R<u32, super::EBI_WTR2>;
#[doc = "Writer for register EBI_WTR2"]
pub type W = crate::W<u32, super::EBI_WTR2>;
#[doc = "Register EBI_WTR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::EBI_WTR2 {
    type Type = u32;
    #[inline(always)]
