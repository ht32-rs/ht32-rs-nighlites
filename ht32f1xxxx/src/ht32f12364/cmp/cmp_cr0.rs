#[doc = "Reader of register CMP_CR0"]
pub type R = crate::R<u32, super::CMP_CR0>;
#[doc = "Writer for register CMP_CR0"]
pub type W = crate::W<u32, super::CMP_CR0>;
#[doc = "Register CMP_CR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP_CR0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `PRETECT`"]
pub type PRETECT_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `PRETECT`"]
pub struct PRETECT_W<'a> {
    w: &'a mut W,
}
impl<'a> PRETECT_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    pub fn cmpsel(&self) -> CMPSEL_R {
        CMPSEL_R::new(((self.bits >> 11) & 0x07) as u8)
    }
    #[doc = "Bit 14 - CMPWPEN"]
    #[inline(always)]
