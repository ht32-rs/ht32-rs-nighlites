...
pub type RTCCNT_R = crate::FieldReader<u32>;
#[doc = "Field `RTCCNT` writer - RTCCNT"]
pub type RTCCNT_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_CNT_SPEC, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - RTCCNT"]
    #[inline(always)]
    pub fn rtccnt(&self) -> RTCCNT_R {
        RTCCNT_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - RTCCNT"]
    #[inline(always)]
    #[must_use]
    pub fn rtccnt(&mut self) -> RTCCNT_W<0> {
        RTCCNT_W::new(self)
    }
