...
pub type LVDS_R = crate::FieldReader;
#[doc = "Field `LVDS` writer - LVDS"]
pub type LVDS_W<'a, const O: u8> = crate::FieldWriter<'a, PWRCU_LVDCSR_SPEC, 2, O>;
...
#[doc = "Field `LVDS2` reader - LVDEWEN"]
pub type LVDS2_R = crate::BitReader;
#[doc = "Field `LVDS2` writer - LVDEWEN"]
...
impl R {
    ...
    pub fn lvds(&self) -> LVDS_R {
        LVDS_R::new(((self.bits >> 17) & 3) as u8)
    }
    #[doc = "Bit 19 - LVDF"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lvds(&mut self) -> LVDS_W<17> {
        LVDS_W::new(self)
    }
    #[doc = "Bit 19 - LVDF"]
    #[inline(always)]
