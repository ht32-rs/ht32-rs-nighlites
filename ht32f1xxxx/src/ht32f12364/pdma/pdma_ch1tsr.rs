#[doc = "Reader of register PDMA_CH1TSR"]
pub type R = crate::R<u32, super::PDMA_CH1TSR>;
#[doc = "Writer for register PDMA_CH1TSR"]
pub type W = crate::W<u32, super::PDMA_CH1TSR>;
#[doc = "Register PDMA_CH1TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH1TSR {
    type Type = u32;
    #[inline(always)]
