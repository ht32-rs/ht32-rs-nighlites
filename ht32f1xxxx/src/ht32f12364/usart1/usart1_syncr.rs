#[doc = "Reader of register USART1_SYNCR"]
pub type R = crate::R<u32, super::USART1_SYNCR>;
#[doc = "Writer for register USART1_SYNCR"]
pub type W = crate::W<u32, super::USART1_SYNCR>;
#[doc = "Register USART1_SYNCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART1_SYNCR {
    type Type = u32;
    #[inline(always)]
