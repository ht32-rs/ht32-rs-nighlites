...
pub struct R(crate::R<GPTM_CNTCFR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPTM_CNTCFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPTM_CNTCFR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPTM_CNTCFR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPTM_CNTCFR` writer"]
pub struct W(crate::W<GPTM_CNTCFR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPTM_CNTCFR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPTM_CNTCFR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPTM_CNTCFR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UEVDIS_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CNTCFR_SPEC, O>;
#[doc = "Field `UGDIS` reader - UGDIS"]
pub type UGDIS_R = crate::BitReader;
#[doc = "Field `UGDIS` writer - UGDIS"]
pub type UGDIS_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CNTCFR_SPEC, O>;
#[doc = "Field `CKDIV` reader - CKDIV"]
pub type CKDIV_R = crate::FieldReader;
#[doc = "Field `CKDIV` writer - CKDIV"]
pub type CKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, GPTM_CNTCFR_SPEC, 2, O>;
#[doc = "Field `CMSEL` reader - CMSEL"]
pub type CMSEL_R = crate::FieldReader;
#[doc = "Field `CMSEL` writer - CMSEL"]
pub type CMSEL_W<'a, const O: u8> = crate::FieldWriter<'a, GPTM_CNTCFR_SPEC, 2, O>;
#[doc = "Field `DIR` reader - DIR"]
pub type DIR_R = crate::BitReader;
#[doc = "Field `DIR` writer - DIR"]
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, GPTM_CNTCFR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - UEVDIS"]
    #[inline(always)]
...
#[doc = "GPTM_CNTCFR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gptm_cntcfr](index.html) module"]
pub struct GPTM_CNTCFR_SPEC;
impl crate::RegisterSpec for GPTM_CNTCFR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gptm_cntcfr::R](R) reader structure"]
impl crate::Readable for GPTM_CNTCFR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gptm_cntcfr::W](W) writer structure"]
impl crate::Writable for GPTM_CNTCFR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPTM_CNTCFR to value 0"]
impl crate::Resettable for GPTM_CNTCFR_SPEC {
