#[doc = "Reader of register SCI_CR"]
pub type R = crate::R<u32, super::SCI_CR>;
#[doc = "Writer for register SCI_CR"]
pub type W = crate::W<u32, super::SCI_CR>;
#[doc = "Register SCI_CR `reset()`'s with value 0"]
impl crate::ResetValue for super::SCI_CR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `RETRY4_5`"]
pub type RETRY4_5_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RETRY4_5`"]
pub struct RETRY4_5_W<'a> {
    w: &'a mut W,
}
impl<'a> RETRY4_5_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[doc = "Bit 4 - RETRY4_5"]
    #[inline(always)]
    pub fn retry4_5(&self) -> RETRY4_5_R {
        RETRY4_5_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - ENSCI"]
    #[inline(always)]
