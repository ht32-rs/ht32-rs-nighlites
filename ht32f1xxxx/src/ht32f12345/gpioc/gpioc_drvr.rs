#[doc = "Reader of register GPIOC_DRVR"]
pub type R = crate::R<u32, super::GPIOC_DRVR>;
#[doc = "Writer for register GPIOC_DRVR"]
pub type W = crate::W<u32, super::GPIOC_DRVR>;
#[doc = "Register GPIOC_DRVR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOC_DRVR {
    type Type = u32;
    #[inline(always)]
