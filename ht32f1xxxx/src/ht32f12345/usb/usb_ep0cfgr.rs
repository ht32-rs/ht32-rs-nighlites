#[doc = "Reader of register USB_EP0CFGR"]
pub type R = crate::R<u32, super::USB_EP0CFGR>;
#[doc = "Writer for register USB_EP0CFGR"]
pub type W = crate::W<u32, super::USB_EP0CFGR>;
#[doc = "Register USB_EP0CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_EP0CFGR {
    type Type = u32;
    #[inline(always)]
