#[doc = "Reader of register USB_EP0TCR"]
pub type R = crate::R<u32, super::USB_EP0TCR>;
#[doc = "Writer for register USB_EP0TCR"]
pub type W = crate::W<u32, super::USB_EP0TCR>;
#[doc = "Register USB_EP0TCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_EP0TCR {
    type Type = u32;
    #[inline(always)]
