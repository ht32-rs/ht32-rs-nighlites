...
#[doc = "Field `EBIARDY` reader - EBIARDY"]
pub type EBIARDY_R = crate::BitReader;
#[doc = "Field `EBIARDY` writer - EBIARDY"]
pub type EBIARDY_W<'a, const O: u8> = crate::BitWriter<'a, EBI_SR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ebiardy(&mut self) -> EBIARDY_W<4> {
        EBIARDY_W::new(self)
    }
    #[doc = "Bit 8 - EBISMRST"]
    #[inline(always)]
