#[doc = "Reader of register USART1_MDR"]
pub type R = crate::R<u32, super::USART1_MDR>;
#[doc = "Writer for register USART1_MDR"]
pub type W = crate::W<u32, super::USART1_MDR>;
#[doc = "Register USART1_MDR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART1_MDR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn txdmaen(&self) -> TXDMAEN_R {
        TXDMAEN_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - RXDMAEN"]
    #[inline(always)]
    pub fn rxdmaen(&self) -> RXDMAEN_R {
        RXDMAEN_R::new(((self.bits >> 5) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - MODE"]
