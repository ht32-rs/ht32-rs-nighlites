#[doc = "Reader of register PDMA_CH0CTSR"]
pub type R = crate::R<u32, super::PDMA_CH0CTSR>;
#[doc = "Writer for register PDMA_CH0CTSR"]
pub type W = crate::W<u32, super::PDMA_CH0CTSR>;
#[doc = "Register PDMA_CH0CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::PDMA_CH0CTSR {
    type Type = u32;
    #[inline(always)]
