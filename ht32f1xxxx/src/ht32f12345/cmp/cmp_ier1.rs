#[doc = "Reader of register CMP_IER1"]
pub type R = crate::R<u32, super::CMP_IER1>;
#[doc = "Writer for register CMP_IER1"]
pub type W = crate::W<u32, super::CMP_IER1>;
#[doc = "Register CMP_IER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMP_IER1 {
    type Type = u32;
    #[inline(always)]
