...
#[doc = "GPIOD_ODR"]
pub mod gpiod_odr;
#[doc = "GPIOD_DRVR\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpiod_drvr](gpiod_drvr) module"]
pub type GPIOD_DRVR = crate::Reg<u32, _GPIOD_DRVR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _GPIOD_DRVR;
#[doc = "`read()` method returns [gpiod_drvr::R](gpiod_drvr::R) reader structure"]
impl crate::Readable for GPIOD_DRVR {}
#[doc = "`write(|w| ..)` method takes [gpiod_drvr::W](gpiod_drvr::W) writer structure"]
impl crate::Writable for GPIOD_DRVR {}
#[doc = "GPIOD_DRVR"]
pub mod gpiod_drvr;
