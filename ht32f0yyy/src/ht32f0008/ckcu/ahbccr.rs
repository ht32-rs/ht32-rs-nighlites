...
#[doc = "Field `PFEN` reader - PFEN"]
pub type PFEN_R = crate::BitReader;
#[doc = "Field `PFEN` writer - PFEN"]
pub type PFEN_W<'a, const O: u8> = crate::BitWriter<'a, AHBCCR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pfen(&mut self) -> PFEN_W<21> {
        PFEN_W::new(self)
    }
    #[doc = "Bit 24 - DIVEN"]
    #[inline(always)]
