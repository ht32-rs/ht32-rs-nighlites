...
impl From<crate::R<SPICR1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SPICR1_SPEC>> for W {
    #[inline(always)]
...
#[doc = "`reset()` method sets SPICR1 to value 0"]
