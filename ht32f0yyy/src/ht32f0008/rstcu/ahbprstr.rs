...
#[doc = "Field `PFRST` reader - PFRST"]
pub type PFRST_R = crate::BitReader;
#[doc = "Field `PFRST` writer - PFRST"]
pub type PFRST_W<'a, const O: u8> = crate::BitWriter<'a, AHBPRSTR_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pfrst(&mut self) -> PFRST_W<13> {
        PFRST_W::new(self)
    }
    #[doc = "Bit 15 - AESRST"]
    #[inline(always)]
