#[doc = "Register `QSPI_IER` reader"]
pub struct R(crate::R<QSPI_IER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<QSPI_IER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<QSPI_IER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<QSPI_IER_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "`read()` method returns [qspi_ier::R](R) reader structure"]
impl crate::Readable for QSPI_IER_SPEC {
    type Reader = R;
}
