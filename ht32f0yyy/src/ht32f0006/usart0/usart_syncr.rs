...
pub type CLKEN_W<'a, const O: u8> = crate::BitWriter<'a, USART_SYNCR_SPEC, O>;
#[doc = "Field `CPS` reader - CPS"]
pub type CPS_R = crate::BitReader;
#[doc = "Field `CPS` writer - CPS"]
pub type CPS_W<'a, const O: u8> = crate::BitWriter<'a, USART_SYNCR_SPEC, O>;
#[doc = "Field `CPO` reader - CPO"]
pub type CPO_R = crate::BitReader;
#[doc = "Field `CPO` writer - CPO"]
pub type CPO_W<'a, const O: u8> = crate::BitWriter<'a, USART_SYNCR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CLKEN"]
    #[inline(always)]
