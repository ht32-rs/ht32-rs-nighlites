...
#[doc = "Field `PDPU` reader - PDPU"]
pub type PDPU_R = crate::FieldReader;
#[doc = "Field `PDPU` writer - PDPU"]
pub type PDPU_W<'a, const O: u8> = crate::FieldWriter<'a, PDPUR_SPEC, 4, O>;
impl R {
    #[doc = "Bits 0:3 - PDPU"]
    #[inline(always)]
    pub fn pdpu(&self) -> PDPU_R {
        PDPU_R::new((self.bits & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - PDPU"]
