#![doc = "Peripheral access API for HT32F61352 microcontrollers (generated using svd2rust v0.29.0 (615f093 2023-06-05))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl MIDI {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const midi::RegisterBlock = 0x4006_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const midi::RegisterBlock {
        Self::PTR
    }
}
impl Deref for MIDI {
    type Target = midi::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
