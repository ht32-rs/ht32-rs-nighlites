...
pub struct RegisterBlock {
    ...
    #[doc = "0x48 - CKCU_APBPCSR2"]
    pub ckcu_apbpcsr2: CKCU_APBPCSR2,
    _reserved17: [u8; 0x02b4],
    #[doc = "0x300 - CKCU_LPCR"]
...
#[doc = "CKCU_CKST"]
pub mod ckcu_ckst;
#[doc = "CKCU_APBPCSR0 (rw) register accessor: an alias for `Reg<CKCU_APBPCSR0_SPEC>`"]
pub type CKCU_APBPCSR0 = crate::Reg<ckcu_apbpcsr0::CKCU_APBPCSR0_SPEC>;
#[doc = "CKCU_APBPCSR0"]
pub mod ckcu_apbpcsr0;
#[doc = "CKCU_APBPCSR1 (rw) register accessor: an alias for `Reg<CKCU_APBPCSR1_SPEC>`"]
pub type CKCU_APBPCSR1 = crate::Reg<ckcu_apbpcsr1::CKCU_APBPCSR1_SPEC>;
#[doc = "CKCU_APBPCSR1"]
pub mod ckcu_apbpcsr1;
#[doc = "CKCU_HSICR (rw) register accessor: an alias for `Reg<CKCU_HSICR_SPEC>`"]
pub type CKCU_HSICR = crate::Reg<ckcu_hsicr::CKCU_HSICR_SPEC>;
#[doc = "CKCU_HSICR"]
pub mod ckcu_hsicr;
#[doc = "CKCU_HSIATCR (rw) register accessor: an alias for `Reg<CKCU_HSIATCR_SPEC>`"]
pub type CKCU_HSIATCR = crate::Reg<ckcu_hsiatcr::CKCU_HSIATCR_SPEC>;
#[doc = "CKCU_HSIATCR"]
pub mod ckcu_hsiatcr;
#[doc = "CKCU_APBPCSR2 (rw) register accessor: an alias for `Reg<CKCU_APBPCSR2_SPEC>`"]
pub type CKCU_APBPCSR2 = crate::Reg<ckcu_apbpcsr2::CKCU_APBPCSR2_SPEC>;
#[doc = "CKCU_APBPCSR2"]
pub mod ckcu_apbpcsr2;
