...
#[doc = "Field `PBDOUT` reader - PBDOUT"]
pub type PBDOUT_R = crate::FieldReader<u16>;
#[doc = "Field `PBDOUT` writer - PBDOUT"]
pub type PBDOUT_W<'a, const O: u8> = crate::FieldWriter<'a, PBDOUTR_SPEC, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - PBDOUT"]
    #[inline(always)]
    pub fn pbdout(&self) -> PBDOUT_R {
        PBDOUT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - PBDOUT"]
    #[inline(always)]
    #[must_use]
    pub fn pbdout(&mut self) -> PBDOUT_W<0> {
        PBDOUT_W::new(self)
    }
