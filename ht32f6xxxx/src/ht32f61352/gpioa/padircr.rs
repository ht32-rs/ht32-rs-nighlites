...
#[doc = "Field `PADIR` reader - PADIR"]
pub type PADIR_R = crate::FieldReader<u16>;
#[doc = "Field `PADIR` writer - PADIR"]
pub type PADIR_W<'a, const O: u8> = crate::FieldWriter<'a, PADIRCR_SPEC, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - PADIR"]
    #[inline(always)]
    pub fn padir(&self) -> PADIR_R {
        PADIR_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - PADIR"]
    #[inline(always)]
    #[must_use]
    pub fn padir(&mut self) -> PADIR_W<0> {
        PADIR_W::new(self)
    }
