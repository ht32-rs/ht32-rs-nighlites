#[doc = "Register `CH0CR` reader"]
pub struct R(crate::R<CH0CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH0CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH0CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH0CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH0CR` writer"]
pub struct W(crate::W<CH0CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH0CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH0CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH0CR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PDMA_CH0CR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch0cr](index.html) module"]
pub struct CH0CR_SPEC;
impl crate::RegisterSpec for CH0CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch0cr::R](R) reader structure"]
impl crate::Readable for CH0CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch0cr::W](W) writer structure"]
impl crate::Writable for CH0CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CH0CR to value 0"]
impl crate::Resettable for CH0CR_SPEC {
