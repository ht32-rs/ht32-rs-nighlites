...
pub type DBCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR0_SPEC, 16, O, u16>;
#[doc = "Field `SRCTYPE` reader - SRCTYPE"]
pub type SRCTYPE_R = crate::FieldReader;
#[doc = "Field `SRCTYPE` writer - SRCTYPE"]
pub type SRCTYPE_W<'a, const O: u8> = crate::FieldWriter<'a, CFGR0_SPEC, 3, O>;
#[doc = "Field `DBEN` reader - DBEN"]
pub type DBEN_R = crate::BitReader;
#[doc = "Field `DBEN` writer - DBEN"]
pub type DBEN_W<'a, const O: u8> = crate::BitWriter<'a, CFGR0_SPEC, O>;
impl R {
    #[doc = "Bits 0:15 - DBCNT"]
    #[inline(always)]
