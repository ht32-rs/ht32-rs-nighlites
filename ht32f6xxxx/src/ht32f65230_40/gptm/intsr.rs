...
#[doc = "Field `VCIF` reader - VCIF"]
pub type VCIF_R = crate::BitReader;
#[doc = "Field `VCIF` writer - VCIF"]
pub type VCIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `QCIF` reader - QCIF"]
pub type QCIF_R = crate::BitReader;
#[doc = "Field `QCIF` writer - QCIF"]
pub type QCIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `PEIF` reader - PEIF"]
pub type PEIF_R = crate::BitReader;
#[doc = "Field `PEIF` writer - PEIF"]
pub type PEIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
#[doc = "Field `DCIF` reader - DCIF"]
pub type DCIF_R = crate::BitReader;
#[doc = "Field `DCIF` writer - DCIF"]
pub type DCIF_W<'a, const O: u8> = crate::BitWriter<'a, INTSR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - CH0CCIF"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - VCIF"]
    #[inline(always)]
    pub fn vcif(&self) -> VCIF_R {
        VCIF_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - QCIF"]
    #[inline(always)]
    pub fn qcif(&self) -> QCIF_R {
        QCIF_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - PEIF"]
    #[inline(always)]
    pub fn peif(&self) -> PEIF_R {
        PEIF_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - DCIF"]
    #[inline(always)]
    pub fn dcif(&self) -> DCIF_R {
        DCIF_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - CH0CCIF"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn vcif(&mut self) -> VCIF_W<12> {
        VCIF_W::new(self)
    }
    #[doc = "Bit 13 - QCIF"]
    #[inline(always)]
    #[must_use]
    pub fn qcif(&mut self) -> QCIF_W<13> {
        QCIF_W::new(self)
    }
    #[doc = "Bit 14 - PEIF"]
    #[inline(always)]
    #[must_use]
    pub fn peif(&mut self) -> PEIF_W<14> {
        PEIF_W::new(self)
    }
    #[doc = "Bit 15 - DCIF"]
    #[inline(always)]
    #[must_use]
    pub fn dcif(&mut self) -> DCIF_W<15> {
        DCIF_W::new(self)
    }
