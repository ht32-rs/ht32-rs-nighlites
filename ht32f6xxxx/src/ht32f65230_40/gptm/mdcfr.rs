...
pub type TSE_W<'a, const O: u8> = crate::BitWriter<'a, MDCFR_SPEC, O>;
#[doc = "Field `SMSEL` reader - SMSEL"]
pub type SMSEL_R = crate::FieldReader;
#[doc = "Field `SMSEL` writer - SMSEL"]
pub type SMSEL_W<'a, const O: u8> = crate::FieldWriter<'a, MDCFR_SPEC, 4, O>;
#[doc = "Field `MMSEL` reader - MMSEL"]
pub type MMSEL_R = crate::FieldReader;
#[doc = "Field `MMSEL` writer - MMSEL"]
pub type MMSEL_W<'a, const O: u8> = crate::FieldWriter<'a, MDCFR_SPEC, 4, O>;
#[doc = "Field `SPMSET` reader - SPMSET"]
pub type SPMSET_R = crate::BitReader;
#[doc = "Field `SPMSET` writer - SPMSET"]
pub type SPMSET_W<'a, const O: u8> = crate::BitWriter<'a, MDCFR_SPEC, O>;
#[doc = "Field `QEISYNC` reader - QEISYNC"]
pub type QEISYNC_R = crate::FieldReader;
#[doc = "Field `QEISYNC` writer - QEISYNC"]
pub type QEISYNC_W<'a, const O: u8> = crate::FieldWriter<'a, MDCFR_SPEC, 4, O>;
impl R {
    #[doc = "Bit 0 - TSE"]
    #[inline(always)]
    ...
    pub fn smsel(&self) -> SMSEL_R {
        SMSEL_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bits 16:19 - MMSEL"]
    #[inline(always)]
    pub fn mmsel(&self) -> MMSEL_R {
        MMSEL_R::new(((self.bits >> 16) & 0x0f) as u8)
    }
    #[doc = "Bit 24 - SPMSET"]
    #[inline(always)]
    ...
    #[doc = "Bits 28:31 - QEISYNC"]
    #[inline(always)]
    pub fn qeisync(&self) -> QEISYNC_R {
        QEISYNC_R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - TSE"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn qeisync(&mut self) -> QEISYNC_W<28> {
        QEISYNC_W::new(self)
    }
