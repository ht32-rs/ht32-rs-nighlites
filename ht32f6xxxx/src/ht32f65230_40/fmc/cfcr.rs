...
pub type WAIT_W<'a, const O: u8> = crate::FieldWriter<'a, CFCR_SPEC, 3, O>;
#[doc = "Field `PFBE` reader - PFBE"]
pub type PFBE_R = crate::BitReader;
#[doc = "Field `PFBE` writer - PFBE"]
pub type PFBE_W<'a, const O: u8> = crate::BitWriter<'a, CFCR_SPEC, O>;
#[doc = "Field `CE` reader - CE"]
pub type CE_R = crate::BitReader;
#[doc = "Field `CE` writer - CE"]
pub type CE_W<'a, const O: u8> = crate::BitWriter<'a, CFCR_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - WAIT"]
    #[inline(always)]
