...
pub type UEV1DIS_W<'a, const O: u8> = crate::BitWriter<'a, CNTCFR_SPEC, O>;
#[doc = "Field `UGDIS` reader - UGDIS"]
pub type UGDIS_R = crate::BitReader;
#[doc = "Field `UGDIS` writer - UGDIS"]
pub type UGDIS_W<'a, const O: u8> = crate::BitWriter<'a, CNTCFR_SPEC, O>;
#[doc = "Field `UEV1UD` reader - UEV1UD"]
pub type UEV1UD_R = crate::BitReader;
#[doc = "Field `UEV1UD` writer - UEV1UD"]
pub type UEV1UD_W<'a, const O: u8> = crate::BitWriter<'a, CNTCFR_SPEC, O>;
#[doc = "Field `UEV1OD` reader - UEV1OD"]
pub type UEV1OD_R = crate::BitReader;
#[doc = "Field `UEV1OD` writer - UEV1OD"]
pub type UEV1OD_W<'a, const O: u8> = crate::BitWriter<'a, CNTCFR_SPEC, O>;
#[doc = "Field `CKDIV` reader - CKDIV"]
pub type CKDIV_R = crate::FieldReader;
#[doc = "Field `CKDIV` writer - CKDIV"]
pub type CKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, CNTCFR_SPEC, 2, O>;
#[doc = "Field `CMSEL` reader - CMSEL"]
pub type CMSEL_R = crate::FieldReader;
#[doc = "Field `CMSEL` writer - CMSEL"]
pub type CMSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CNTCFR_SPEC, 2, O>;
#[doc = "Field `DIR` reader - DIR"]
pub type DIR_R = crate::BitReader;
#[doc = "Field `DIR` writer - DIR"]
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, CNTCFR_SPEC, O>;
impl R {
    #[doc = "Bit 0 - UEV1DIS"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - UEV1UD"]
    #[inline(always)]
    pub fn uev1ud(&self) -> UEV1UD_R {
        UEV1UD_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - UEV1OD"]
    #[inline(always)]
    pub fn uev1od(&self) -> UEV1OD_R {
        UEV1OD_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 8:9 - CKDIV"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uev1ud(&mut self) -> UEV1UD_W<2> {
        UEV1UD_W::new(self)
    }
    #[doc = "Bit 3 - UEV1OD"]
    #[inline(always)]
    #[must_use]
    pub fn uev1od(&mut self) -> UEV1OD_W<3> {
        UEV1OD_W::new(self)
    }
    #[doc = "Bits 8:9 - CKDIV"]
    #[inline(always)]
