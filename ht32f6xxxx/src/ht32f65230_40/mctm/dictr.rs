...
pub type UEV1IE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `UEV2IE` reader - UEV2IE"]
pub type UEV2IE_R = crate::BitReader;
#[doc = "Field `UEV2IE` writer - UEV2IE"]
pub type UEV2IE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
...
pub type BRKIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `OVERIE` reader - OVERIE"]
pub type OVERIE_R = crate::BitReader;
#[doc = "Field `OVERIE` writer - OVERIE"]
pub type OVERIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `UNDERIE` reader - UNDERIE"]
pub type UNDERIE_R = crate::BitReader;
#[doc = "Field `UNDERIE` writer - UNDERIE"]
pub type UNDERIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
...
#[doc = "Field `CH0CDIE` reader - CH0CDIE"]
pub type CH0CDIE_R = crate::BitReader;
#[doc = "Field `CH0CDIE` writer - CH0CDIE"]
pub type CH0CDIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH1CDIE` reader - CH1CDIE"]
pub type CH1CDIE_R = crate::BitReader;
#[doc = "Field `CH1CDIE` writer - CH1CDIE"]
pub type CH1CDIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH2CDIE` reader - CH2CDIE"]
pub type CH2CDIE_R = crate::BitReader;
#[doc = "Field `CH2CDIE` writer - CH2CDIE"]
pub type CH2CDIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `CH3CDIE` reader - CH3CDIE"]
pub type CH3CDIE_R = crate::BitReader;
#[doc = "Field `CH3CDIE` writer - CH3CDIE"]
pub type CH3CDIE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `UEV1DE` reader - UEV1DE"]
pub type UEV1DE_R = crate::BitReader;
#[doc = "Field `UEV1DE` writer - UEV1DE"]
pub type UEV1DE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
#[doc = "Field `UEV2DE` reader - UEV2DE"]
pub type UEV2DE_R = crate::BitReader;
#[doc = "Field `UEV2DE` writer - UEV2DE"]
pub type UEV2DE_W<'a, const O: u8> = crate::BitWriter<'a, DICTR_SPEC, O>;
...
impl R {
    ...
    #[doc = "Bit 13 - OVERIE"]
    #[inline(always)]
    pub fn overie(&self) -> OVERIE_R {
        OVERIE_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - UNDERIE"]
    #[inline(always)]
    pub fn underie(&self) -> UNDERIE_R {
        UNDERIE_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 16 - CH0CCDE"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - CH0CDIE"]
    #[inline(always)]
    pub fn ch0cdie(&self) -> CH0CDIE_R {
        CH0CDIE_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - CH1CDIE"]
    #[inline(always)]
    pub fn ch1cdie(&self) -> CH1CDIE_R {
        CH1CDIE_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - CH2CDIE"]
    #[inline(always)]
    pub fn ch2cdie(&self) -> CH2CDIE_R {
        CH2CDIE_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - CH3CDIE"]
    #[inline(always)]
    pub fn ch3cdie(&self) -> CH3CDIE_R {
        CH3CDIE_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - UEV1DE"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn overie(&mut self) -> OVERIE_W<13> {
        OVERIE_W::new(self)
    }
    #[doc = "Bit 14 - UNDERIE"]
    #[inline(always)]
    #[must_use]
    pub fn underie(&mut self) -> UNDERIE_W<14> {
        UNDERIE_W::new(self)
    }
    #[doc = "Bit 16 - CH0CCDE"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0cdie(&mut self) -> CH0CDIE_W<20> {
        CH0CDIE_W::new(self)
    }
    #[doc = "Bit 21 - CH1CDIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch1cdie(&mut self) -> CH1CDIE_W<21> {
        CH1CDIE_W::new(self)
    }
    #[doc = "Bit 22 - CH2CDIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch2cdie(&mut self) -> CH2CDIE_W<22> {
        CH2CDIE_W::new(self)
    }
    #[doc = "Bit 23 - CH3CDIE"]
    #[inline(always)]
    #[must_use]
    pub fn ch3cdie(&mut self) -> CH3CDIE_W<23> {
        CH3CDIE_W::new(self)
    }
    #[doc = "Bit 24 - UEV1DE"]
    #[inline(always)]
